...
import {userCanSubmission, userCan} from 'js/components/permissions/utils';
          ...
          <bem.FormModal__group>
            <div className='submission-duplicate__actions'>
              {(userCan('change_submissions', this.props.asset) ||
                userCanSubmission('change_submissions', this.props.asset, this.state.submission)) &&
                <a
              ...
              {(userCan('delete_submissions', this.props.asset) ||
                userCanSubmission('delete_submissions', this.props.asset, this.state.submission)) &&
                <a
              ...
              <div className='switch--validation-status'>
                ...
                <Select
                  isDisabled={!(
                    ...
                    userCanSubmission('validate_submissions', this.props.asset, this.state.submission)
                  )}
                  isClearable={false}
          ...
          <bem.FormModal__group>
            ...
            <div className='submission-actions'>
              ...
              {(
                ...
                userCanSubmission('view_submissions', this.props.asset, this.state.submission)
              ) &&
                <a
