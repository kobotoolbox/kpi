...
export default function AudioCell(props: AudioCellProps) {
  ...
  // If attachment for this submission response is deleted, and there is no NLP related features being used with it, we
  // don't want to show the button, as it doesn't make sense to open the processing view for it.
  const isProcessingAvailable =
    Object.keys(props.submissionData._supplementalDetails).length > 0 && typeof props.mediaAttachment !== 'string'
