...
import { formatTime, anonUsername, t, assign, validFileTypes } from '../utils';
...
class AssetRow extends React.Component {
  ...
  clickAssetButton(evt) {
    var clickedActionIcon = $(evt.target)
      .closest('[data-action]')
      .get(0);
    if (clickedActionIcon) {
      var action = clickedActionIcon.getAttribute('data-action');
      var name =
        clickedActionIcon.getAttribute('data-asset-name') || t('untitled');
  ...
  render() {
    ...
    var hrefTo = `/forms/${this.props.uid}`,
      linkClassName = this.props.name
        ? 'asset-row__celllink--titled'
        : 'asset-row__celllink--untitled',
      tags = this.props.tags || [],
      ownedCollections = [],
      parent = undefined;
        ...
        >
          <bem.AssetRow__cell
            ...
            className={[
              'mdl-cell',
              this.props.asset_type == 'survey'
                ? 'mdl-cell--5-col mdl-cell--4-col-tablet mdl-cell--2-col-phone'
                : 'mdl-cell--8-col mdl-cell--5-col-tablet mdl-cell--2-col-phone'
            ]}
          >
            {this.props.asset_type &&
          ...
          <bem.AssetRow__cell
            ...
            className={[
              'mdl-cell',
              this.props.asset_type == 'survey'
                ? 'mdl-cell--2-col mdl-cell--1-col-tablet mdl-cell--hide-phone'
                : 'mdl-cell--2-col mdl-cell--2-col-tablet mdl-cell--1-col-phone'
            ]}
          >
            {this.props.asset_type == 'survey' && (
          ...
          {this.props.asset_type == 'survey' && (
            ...
            >
              <span className="date date--created">
                {formatTime(this.props.date_created)}
              </span>
            </bem.AssetRow__cell>
          )}
          <bem.AssetRow__cell
            ...
            key={'date-modified'}
            className={[
              'mdl-cell mdl-cell--2-col mdl-cell--2-col-tablet mdl-cell--1-col-phone'
            ]}
          >
            <span className="date date--modified">
