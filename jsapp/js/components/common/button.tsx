...
const Button = (props: ButtonProps) => {
  ...
  const renderButton = () => (
    <button
      className={cx(['k-button', `k-button--type-${props.type}`, `k-button--size-${props.size}`, props.className], {
    ...
    >
      ...
      {/* Ensures only one icon is being displayed.*/}
      {!props.startIcon && props.endIcon && <Icon name={props.endIcon} size={iconSize} />}

      {props.isPending && <Icon name='spinner' size={iconSize} className='k-spin' />}
    </button>
  )
