...
import { getActiveTab, getActiveLanguageCode, goToProcessing } from '#/components/processing/routes.utils'
...
export default function SelectSubmission({ assetUid, submission, xpath, hasUnsavedWork }: Props) {
  ...
  const goPrev = () => {
    ...
    protectorHelpers.safeExecute(hasUnsavedWork, () =>
      goToProcessing(assetUid, xpath, removeDefaultUuidPrefix(queryPrev.data!.submission['meta/rootUuid']), getActiveTab(), getActiveLanguageCode()),
    )
  }
  ...
  const goNext = () => {
    ...
    protectorHelpers.safeExecute(hasUnsavedWork, () =>
      goToProcessing(assetUid, xpath, removeDefaultUuidPrefix(queryNext.data!.submission['meta/rootUuid']), getActiveTab(), getActiveLanguageCode()),
    )
  }
