...
import UsersSidebar from 'js/components/users/usersSidebar';
import {
  IntercomHelpBubble,
  SupportHelpBubble,
} from "../components/helpBubbles";
import { COMMON_QUERIES, MODAL_TYPES, ROUTES } from "../constants";
    ...
    return (
      <bem.KDrawer>
        ...
        <bem.KDrawer__secondaryIcons>
          {stores.session.currentAccount && <IntercomHelpBubble />}
          {stores.session.currentAccount && <SupportHelpBubble />}
