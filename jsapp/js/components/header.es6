...
import { ListSearch, ListTagFilter } from '../components/list';
...
class MainHeader extends Reflux.Component {
  ...
  assetTitleChange(e) {
    ...
    if (e.target.name == 'title') asset.name = e.target.value;
    else asset.settings.description = e.target.value;
      ...
      <header className="mdl-layout__header">
        <div className="mdl-layout__header-row">
          ...
          {this.isLibrary() && (
            <div className="mdl-layout__header-searchers">
              <ListSearch
                searchContext={this.state.libraryFiltersContext}
                placeholderText={t('Search Library')}
              />
            </div>
          )}
          {this.isFormSingle() &&
