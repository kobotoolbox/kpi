...
class MainHeader extends Reflux.Component {
    ...
    renderAccountNavMenu() {
        ...
        if (stores.session.currentAccount) {
            ...
            var accountMenuLabel = <bem.AccountBox__initials
                style={initialsStyle}>{accountName.charAt(0)}</bem.AccountBox__initials>;
                        ...
                        <bem.AccountBox__menu>
                            <bem.AccountBox__menuLI key='1'>
                                ...
                                <bem.AccountBox__menuItem m={'settings'}>
                                    <button onClick={this.accountSettings}
                ...
                <bem.Header__logo/>
                    ...
                    <div className="mdl-layout__header-searchers">
                        <ListSearch searchContext={this.state.formFiltersContext}
                                    placeholderText={t('Buscar proyectos')}/>
                    </div>
                    }
                    {this.isLibrary() &&
                    <div className="mdl-layout__header-searchers">
                        <ListSearch searchContext={this.state.libraryFiltersContext}
                                    placeholderText={t('Buscar Librería')}/>
                    </div>
                    }
                    ...
                    <bem.FormTitle>
                        ...
                        <bem.FormTitle__name data-tip={t('Haz click para editar')}>
                            <input type="text"
                                   name="title"
                                   placeholder={userCanEditAsset ? t('Título del Proyecto') : ''}
                        ...
                        <bem.FormTitle__submissions>
                            {this.state.asset.deployment__submission_count} {t('presentaciones')}
                        </bem.FormTitle__submissions>
                        }
                    </bem.FormTitle>
                    }
