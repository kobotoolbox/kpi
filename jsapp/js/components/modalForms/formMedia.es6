...
reactMixin(FormMedia.prototype, Reflux.ListenerMixin);
reactMixin(FormMedia.prototype, mixins.permissions);
reactMixin(FormMedia.prototype, mixins.droppable);
reactMixin(FormMedia.prototype, mixins.dmix);

FormMedia.contextTypes = {
