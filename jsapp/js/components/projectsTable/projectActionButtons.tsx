...
bem.ProjectActionButtons__iconButton = makeBem(bem.ProjectActionButtons, 'icon-button', 'a');
...
interface ProjectActionButtonsState {
...
class ProjectActionButtons extends React.Component<
  ProjectActionButtonsProps,
  ProjectActionButtonsState
> {
  ...
  constructor(props: ProjectActionButtonsProps) {
    super(props);
    this.state = {
  ...
  renderSubButton() {
    ...
    if (
      ...
      return (
        <bem.ProjectActionButtons__button
          m={modifiers}
          onClick={fn}
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {userCanEdit && assetType !== ASSET_TYPES.collection.id &&
          <bem.ProjectActionButtons__iconButton
