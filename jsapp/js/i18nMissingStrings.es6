...
test= t("The server encountered an error while trying to deploy the project. If this problem persists, please contact <a href=\"mailto:support@kobotoolbox.org\">support@kobotoolbox.org</a>.");
