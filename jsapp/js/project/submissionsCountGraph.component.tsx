...
export default function SubmissionsCountGraph(props: SubmissionsCountGraphProps) {
  ...
  return (
    <section className={styles.root}>
      ...
      >
        ...
        {!isLoading && !hasData && (
          <p className={styles.noChartMessage}>{t('No chart data available for current period.')}</p>
        )}
      </div>

      <div className={styles.statsWrapper}>
        <div className={styles.stats}>
          <span className={styles.statsCount}>{isLoading ? '-' : totalPeriodCount}</span>
          <time className={styles.statsDateRange}>{getDateRangeLabel()}</time>
        </div>

        <div className={styles.stats}>
          <span className={styles.statsCount}>{counts.total_submission_count}</span>
