...
export const ROUTES = Object.freeze({
  ...
  MANAGEMENT_PANEL: '/management/:panelId',
  COLLECTION: '/collection',
  COLLECTION_PANEL: '/collection/:panelId',
  QUALITY_CONTROL: '/quality-control',
  QUALITY_CONTROL_PANEL: '/quality-control/:panelId',
  MR_ANALYSIS: '/mranalysis',
  MR_ANALYSIS_PANEL: '/mranalysis/:panelId',
  INSIGHTZEN_ROOT: '/insightzen',
  INSIGHTZEN_PANEL: '/insightzen/:panelId',
  FORMS: '/forms',
  FORM: '/forms/:uid',
