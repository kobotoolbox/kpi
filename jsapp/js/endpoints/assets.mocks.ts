 ...
 */
const assetsMock = http.get<PathParams<'limit' | 'offset' | 'q'>, never, PaginatedResponse<AssetResponse>>(
  ...
  (info) => {
    ...
    if (searchParams.get('limit') === '1') {
      ...
      return HttpResponse.json(assetsResponseMany)
    }
  },
)
...
const assetsResponseOne: PaginatedResponse<AssetResponse> = {
  count: 1,
  next: null,
  previous: null,
  results: [
...
const assetsResponseMany: PaginatedResponse<AssetResponse> = {
  count: 2,
  next: null,
  previous: null,
  results: [
