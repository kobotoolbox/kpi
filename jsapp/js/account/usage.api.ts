...
interface UsageResponse {
  ...
  total_nlp_asr_seconds_current_month: number;
  total_nlp_asr_seconds_all_time: number;
  total_nlp_mt_characters_current_month: number;
  total_nlp_mt_characters_all_time: number;
}
