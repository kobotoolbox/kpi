...
export const SecurityRoute = React.lazy(() => import(/* webpackPrefetch: true */ './security/securityRoute.component'))
export const PlansRoute = React.lazy(() => import(/* webpackPrefetch: true */ './plans/plan.component'))
export const AddOnsRoute = React.lazy(() => import(/* webpackPrefetch: true */ './addOns/addOns.component'))
export const AccountSettings = React.lazy(() => import(/* webpackPrefetch: true */ './accountSettingsRoute'))
export const DataStorage = React.lazy(() => import(/* webpackPrefetch: true */ './usage/usageTopTabs'))
export const MembersRoute = React.lazy(() => import(/* webpackPrefetch: true */ './organization/MembersRoute'))
