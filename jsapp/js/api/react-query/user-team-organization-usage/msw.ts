...
import {
  AssetDeploymentStatusEnum
} from '../../models/assetDeploymentStatusEnum';
...
import {
  AssetTypeEnum
} from '../../models/assetTypeEnum';

import {
  CustomAssetUsageDeploymentStatusEnum
} from '../../models/customAssetUsageDeploymentStatusEnum';
...
} from '../../models/inviteStatusChoicesEnum';

import {
  InviteeRoleEnum
} from '../../models/inviteeRoleEnum';
...
} from '../../models/organizationTypeEnum';
...
} from '../../models/serviceUsageBalanceData';
...
export const getApiV2OrganizationsInvitesPartialUpdateResponseMock = (overrideResponse: Partial< InviteResponse > = {}): InviteResponse => ({invitee_role: faker.helpers.arrayElement(Object.values(InviteeRoleEnum)), status: faker.helpers.arrayElement(Object.values(InviteStatusChoicesEnum)), url: faker.internet.url(), invited_by: faker.internet.url(), organization_name: faker.string.alpha({length: {min: 10, max: 20}}), created: `${faker.date.past().toISOString().split('.')[0]}Z`, modified: `${faker.date.past().toISOString().split('.')[0]}Z`, invitee: faker.string.alpha({length: {min: 10, max: 20}}), ...overrideResponse})

export const getApiV2OrganizationsMembersListResponseMock = (overrideResponse: Partial< PaginatedMemberListResponseList > = {}): PaginatedMemberListResponseList => ({count: faker.number.int({min: undefined, max: undefined, multipleOf: undefined}), next: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.internet.url(), null]), undefined]), previous: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.internet.url(), null]), undefined]), results: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({role: faker.helpers.arrayElement(Object.values(MemberRoleEnum)), url: faker.internet.url(), user: faker.internet.url(), user__username: faker.string.alpha({length: {min: 10, max: 20}}), user__email: faker.internet.email(), user__extra_details__name: faker.string.alpha({length: {min: 10, max: 20}}), user__has_mfa_enabled: faker.datatype.boolean(), date_joined: `${faker.date.past().toISOString().split('.')[0]}Z`, user__is_active: faker.datatype.boolean(), invite: {...{invitee_role: faker.helpers.arrayElement(Object.values(InviteeRoleEnum)), status: faker.helpers.arrayElement(Object.values(InviteStatusChoicesEnum)), url: faker.internet.url(), invited_by: faker.internet.url(), organization_name: faker.string.alpha({length: {min: 10, max: 20}}), created: `${faker.date.past().toISOString().split('.')[0]}Z`, modified: `${faker.date.past().toISOString().split('.')[0]}Z`, invitee: faker.string.alpha({length: {min: 10, max: 20}})},}})), ...overrideResponse})

export const getApiV2OrganizationsMembersRetrieveResponseMock = (overrideResponse: Partial< MemberListResponse > = {}): MemberListResponse => ({role: faker.helpers.arrayElement(Object.values(MemberRoleEnum)), url: faker.internet.url(), user: faker.internet.url(), user__username: faker.string.alpha({length: {min: 10, max: 20}}), user__email: faker.internet.email(), user__extra_details__name: faker.string.alpha({length: {min: 10, max: 20}}), user__has_mfa_enabled: faker.datatype.boolean(), date_joined: `${faker.date.past().toISOString().split('.')[0]}Z`, user__is_active: faker.datatype.boolean(), invite: {...{invitee_role: faker.helpers.arrayElement(Object.values(InviteeRoleEnum)), status: faker.helpers.arrayElement(Object.values(InviteStatusChoicesEnum)), url: faker.internet.url(), invited_by: faker.internet.url(), organization_name: faker.string.alpha({length: {min: 10, max: 20}}), created: `${faker.date.past().toISOString().split('.')[0]}Z`, modified: `${faker.date.past().toISOString().split('.')[0]}Z`, invitee: faker.string.alpha({length: {min: 10, max: 20}})},}, ...overrideResponse})

export const getApiV2OrganizationsMembersPartialUpdateResponseMock = (overrideResponse: Partial< MemberListResponse > = {}): MemberListResponse => ({role: faker.helpers.arrayElement(Object.values(MemberRoleEnum)), url: faker.internet.url(), user: faker.internet.url(), user__username: faker.string.alpha({length: {min: 10, max: 20}}), user__email: faker.internet.email(), user__extra_details__name: faker.string.alpha({length: {min: 10, max: 20}}), user__has_mfa_enabled: faker.datatype.boolean(), date_joined: `${faker.date.past().toISOString().split('.')[0]}Z`, user__is_active: faker.datatype.boolean(), invite: {...{invitee_role: faker.helpers.arrayElement(Object.values(InviteeRoleEnum)), status: faker.helpers.arrayElement(Object.values(InviteStatusChoicesEnum)), url: faker.internet.url(), invited_by: faker.internet.url(), organization_name: faker.string.alpha({length: {min: 10, max: 20}}), created: `${faker.date.past().toISOString().split('.')[0]}Z`, modified: `${faker.date.past().toISOString().split('.')[0]}Z`, invitee: faker.string.alpha({length: {min: 10, max: 20}})},}, ...overrideResponse})

export const getApiV2OrganizationsServiceUsageRetrieveResponseServiceUsageBalanceDataMock = (overrideResponse: Partial<ServiceUsageBalanceData> = {}): ServiceUsageBalanceData => ({...{effective_limit: faker.number.int({min: undefined, max: undefined, multipleOf: undefined}), balance_value: faker.number.int({min: undefined, max: undefined, multipleOf: undefined}), balance_percent: faker.number.int({min: undefined, max: undefined, multipleOf: undefined}), exceeded: faker.datatype.boolean()}, ...overrideResponse});

export const getApiV2OrganizationsServiceUsageRetrieveResponseMock = (overrideResponse: Partial< OrganizationServiceUsageResponse > = {}): OrganizationServiceUsageResponse => ({total_nlp_usage: {asr_seconds_current_period: faker.number.int({min: undefined, max: undefined, multipleOf: undefined}), llm_requests_current_period: faker.number.int({min: undefined, max: undefined, multipleOf: undefined}), mt_characters_current_period: faker.number.int({min: undefined, max: undefined, multipleOf: undefined}), asr_seconds_all_time: faker.number.int({min: undefined, max: undefined, multipleOf: undefined}), llm_requests_all_time: faker.number.int({min: undefined, max: undefined, multipleOf: undefined}), mt_characters_all_time: faker.number.int({min: undefined, max: undefined, multipleOf: undefined})}, total_storage_bytes: faker.number.int({min: undefined, max: undefined, multipleOf: undefined}), total_submission_count: {all_time: faker.number.int({min: undefined, max: undefined, multipleOf: undefined}), current_period: faker.number.int({min: undefined, max: undefined, multipleOf: undefined})}, balances: {submission: faker.helpers.arrayElement([{...getApiV2OrganizationsServiceUsageRetrieveResponseServiceUsageBalanceDataMock()},null,]), storage_bytes: faker.helpers.arrayElement([{...getApiV2OrganizationsServiceUsageRetrieveResponseServiceUsageBalanceDataMock()},null,]), asr_seconds: faker.helpers.arrayElement([{...getApiV2OrganizationsServiceUsageRetrieveResponseServiceUsageBalanceDataMock()},null,]), mt_characters: faker.helpers.arrayElement([{...getApiV2OrganizationsServiceUsageRetrieveResponseServiceUsageBalanceDataMock()},null,]), llm_requests: faker.helpers.arrayElement([{...getApiV2OrganizationsServiceUsageRetrieveResponseServiceUsageBalanceDataMock()},null,])}, current_period_start: `${faker.date.past().toISOString().split('.')[0]}Z`, current_period_end: `${faker.date.past().toISOString().split('.')[0]}Z`, last_updated: `${faker.date.past().toISOString().split('.')[0]}Z`, ...overrideResponse})

export const getApiV2ProjectViewsListResponseMock = (overrideResponse: Partial< PaginatedProjectViewListResponseList > = {}): PaginatedProjectViewListResponseList => ({count: faker.number.int({min: undefined, max: undefined, multipleOf: undefined}), next: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.internet.url(), null]), undefined]), previous: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.internet.url(), null]), undefined]), results: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({uid: faker.string.alpha({length: {min: 10, max: 32}}), name: faker.internet.url(), url: faker.internet.url(), assets: faker.internet.url(), assets_export: faker.internet.url(), users: faker.internet.url(), users_export: faker.internet.url(), countries: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), permissions: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), assigned_users: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}})))})), ...overrideResponse})

export const getApiV2ProjectViewsRetrieveResponseMock = (overrideResponse: Partial< ProjectViewListResponse > = {}): ProjectViewListResponse => ({uid: faker.string.alpha({length: {min: 10, max: 32}}), name: faker.internet.url(), url: faker.internet.url(), assets: faker.internet.url(), assets_export: faker.internet.url(), users: faker.internet.url(), users_export: faker.internet.url(), countries: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), permissions: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), assigned_users: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), ...overrideResponse})

export const getApiV2ProjectViewsExportRetrieveResponseMock = (overrideResponse: Partial< ProjectViewExportResponse > = {}): ProjectViewExportResponse => ({status: faker.string.alpha({length: {min: 10, max: 32}}), result: faker.internet.url(), ...overrideResponse})

export const getApiV2ProjectViewsExportCreateResponseMock = (overrideResponse: Partial< ProjectViewExportCreateResponse > = {}): ProjectViewExportCreateResponse => ({status: faker.string.alpha({length: {min: 10, max: 32}}), ...overrideResponse})

export const getApiV2ProjectViewsAssetsRetrieveResponseMock = (overrideResponse: Partial< PaginatedProjectViewAssetResponseList > = {}): PaginatedProjectViewAssetResponseList => ({count: faker.number.int({min: undefined, max: undefined, multipleOf: undefined}), next: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.internet.url(), null]), undefined]), previous: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.internet.url(), null]), undefined]), results: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({url: faker.internet.url(), date_created: `${faker.date.past().toISOString().split('.')[0]}Z`, date_modified: `${faker.date.past().toISOString().split('.')[0]}Z`, date_deployed: `${faker.date.past().toISOString().split('.')[0]}Z`, owner: faker.internet.url(), owner__username: faker.string.alpha({length: {min: 10, max: 20}}), owner__email: faker.internet.email(), owner__name: faker.string.alpha({length: {min: 10, max: 20}}), owner__organization: faker.string.alpha({length: {min: 10, max: 20}}), uid: faker.string.alpha({length: {min: 10, max: 20}}), name: faker.string.alpha({length: {min: 10, max: 20}}), settings: {sector: faker.helpers.arrayElement([{label: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), value: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined])}, undefined]), country: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({label: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), value: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined])})), undefined]), description: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), collects_pii: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), organization: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), country_codes: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), undefined]), operational_purpose: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined])}, languages: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), has_deployment: faker.datatype.boolean(), deployment__active: faker.datatype.boolean(), deployment__submission_count: faker.number.int({min: undefined, max: undefined, multipleOf: undefined}), deployment_status: faker.string.alpha({length: {min: 10, max: 20}}), asset_type: faker.string.alpha({length: {min: 10, max: 20}}), downloads: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({format: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), url: faker.helpers.arrayElement([faker.internet.url(), undefined])})), owner_label: faker.string.alpha({length: {min: 10, max: 20}})})), ...overrideResponse})
...
export const getApiV2AssetUsageListMockHandler = (overrideResponse?: PaginatedAssetUsageResponseList | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<PaginatedAssetUsageResponseList> | PaginatedAssetUsageResponseList)) => {
  return http.get('*/api/v2/asset_usage/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
...
export const getApiV2OrganizationsListMockHandler = (overrideResponse?: PaginatedOrganizationResponseList | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<PaginatedOrganizationResponseList> | PaginatedOrganizationResponseList)) => {
  return http.get('*/api/v2/organizations/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2OrganizationsRetrieveMockHandler = (overrideResponse?: OrganizationResponse | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<OrganizationResponse> | OrganizationResponse)) => {
  return http.get('*/api/v2/organizations/:uidOrganization/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2OrganizationsPartialUpdateMockHandler = (overrideResponse?: OrganizationResponse | ((info: Parameters<Parameters<typeof http.patch>[1]>[0]) => Promise<OrganizationResponse> | OrganizationResponse)) => {
  return http.patch('*/api/v2/organizations/:uidOrganization/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2OrganizationsAssetUsageListMockHandler = (overrideResponse?: PaginatedCustomAssetUsageList | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<PaginatedCustomAssetUsageList> | PaginatedCustomAssetUsageList)) => {
  return http.get('*/api/v2/organizations/:uidOrganization/asset_usage/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2OrganizationsAssetsRetrieveMockHandler = (overrideResponse?: PaginatedAssetList | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<PaginatedAssetList> | PaginatedAssetList)) => {
  return http.get('*/api/v2/organizations/:uidOrganization/assets/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2OrganizationsAssetsCountsRetrieveMockHandler = (overrideResponse?: AssetListCount | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<AssetListCount> | AssetListCount)) => {
  return http.get('*/api/v2/organizations/:uidOrganization/assets/counts/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2OrganizationsAssetsMinimalListRetrieveMockHandler = (overrideResponse?: PaginatedAssetMinimalListList | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<PaginatedAssetMinimalListList> | PaginatedAssetMinimalListList)) => {
  return http.get('*/api/v2/organizations/:uidOrganization/assets/minimal-list/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2OrganizationsInvitesListMockHandler = (overrideResponse?: PaginatedInviteResponseList | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<PaginatedInviteResponseList> | PaginatedInviteResponseList)) => {
  return http.get('*/api/v2/organizations/:uidOrganization/invites/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2OrganizationsInvitesCreateMockHandler = (overrideResponse?: InviteCreateResponse | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<InviteCreateResponse> | InviteCreateResponse)) => {
  return http.post('*/api/v2/organizations/:uidOrganization/invites/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2OrganizationsInvitesRetrieveMockHandler = (overrideResponse?: InviteResponse | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<InviteResponse> | InviteResponse)) => {
  return http.get('*/api/v2/organizations/:uidOrganization/invites/:guid/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2OrganizationsInvitesPartialUpdateMockHandler = (overrideResponse?: InviteResponse | ((info: Parameters<Parameters<typeof http.patch>[1]>[0]) => Promise<InviteResponse> | InviteResponse)) => {
  return http.patch('*/api/v2/organizations/:uidOrganization/invites/:guid/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2OrganizationsInvitesDestroyMockHandler = (overrideResponse?: void | ((info: Parameters<Parameters<typeof http.delete>[1]>[0]) => Promise<void> | void)) => {
  return http.delete('*/api/v2/organizations/:uidOrganization/invites/:guid/', async (info) => {if (typeof overrideResponse === 'function') {await overrideResponse(info); }
...
export const getApiV2OrganizationsMembersListMockHandler = (overrideResponse?: PaginatedMemberListResponseList | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<PaginatedMemberListResponseList> | PaginatedMemberListResponseList)) => {
  return http.get('*/api/v2/organizations/:uidOrganization/members/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2OrganizationsMembersRetrieveMockHandler = (overrideResponse?: MemberListResponse | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<MemberListResponse> | MemberListResponse)) => {
  return http.get('*/api/v2/organizations/:uidOrganization/members/:username/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2OrganizationsMembersPartialUpdateMockHandler = (overrideResponse?: MemberListResponse | ((info: Parameters<Parameters<typeof http.patch>[1]>[0]) => Promise<MemberListResponse> | MemberListResponse)) => {
  return http.patch('*/api/v2/organizations/:uidOrganization/members/:username/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2OrganizationsMembersDestroyMockHandler = (overrideResponse?: void | ((info: Parameters<Parameters<typeof http.delete>[1]>[0]) => Promise<void> | void)) => {
  return http.delete('*/api/v2/organizations/:uidOrganization/members/:username/', async (info) => {if (typeof overrideResponse === 'function') {await overrideResponse(info); }
    return new HttpResponse(null,
      { status: 204,
...
export const getApiV2OrganizationsServiceUsageRetrieveMockHandler = (overrideResponse?: OrganizationServiceUsageResponse | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<OrganizationServiceUsageResponse> | OrganizationServiceUsageResponse)) => {
  return http.get('*/api/v2/organizations/:uidOrganization/service_usage/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2ProjectViewsListMockHandler = (overrideResponse?: PaginatedProjectViewListResponseList | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<PaginatedProjectViewListResponseList> | PaginatedProjectViewListResponseList)) => {
  return http.get('*/api/v2/project-views/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2ProjectViewsRetrieveMockHandler = (overrideResponse?: ProjectViewListResponse | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ProjectViewListResponse> | ProjectViewListResponse)) => {
  return http.get('*/api/v2/project-views/:uidProjectView/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2ProjectViewsExportRetrieveMockHandler = (overrideResponse?: ProjectViewExportResponse | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ProjectViewExportResponse> | ProjectViewExportResponse)) => {
  return http.get('*/api/v2/project-views/:uidProjectView/:objType/export/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2ProjectViewsExportCreateMockHandler = (overrideResponse?: ProjectViewExportCreateResponse | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<ProjectViewExportCreateResponse> | ProjectViewExportCreateResponse)) => {
  return http.post('*/api/v2/project-views/:uidProjectView/:objType/export/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2ProjectViewsAssetsRetrieveMockHandler = (overrideResponse?: PaginatedProjectViewAssetResponseList | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<PaginatedProjectViewAssetResponseList> | PaginatedProjectViewAssetResponseList)) => {
  return http.get('*/api/v2/project-views/:uidProjectView/assets/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2ProjectViewsAssetsCountsRetrieveMockHandler = (overrideResponse?: AssetListCount | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<AssetListCount> | AssetListCount)) => {
  return http.get('*/api/v2/project-views/:uidProjectView/assets/counts/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2ProjectViewsAssetsMinimalListRetrieveMockHandler = (overrideResponse?: PaginatedAssetMinimalListList | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<PaginatedAssetMinimalListList> | PaginatedAssetMinimalListList)) => {
  return http.get('*/api/v2/project-views/:uidProjectView/assets/minimal-list/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2ProjectViewsUsersRetrieveMockHandler = (overrideResponse?: PaginatedProjectViewUserResponseList | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<PaginatedProjectViewUserResponseList> | PaginatedProjectViewUserResponseList)) => {
  return http.get('*/api/v2/project-views/:uidProjectView/users/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2ServiceUsageListMockHandler = (overrideResponse?: ServiceUsageResponse[] | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ServiceUsageResponse[]> | ServiceUsageResponse[])) => {
  return http.get('*/api/v2/service_usage/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2UsersListMockHandler = (overrideResponse?: PaginatedUserListResponseList | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<PaginatedUserListResponseList> | PaginatedUserListResponseList)) => {
  return http.get('*/api/v2/users/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getApiV2UsersRetrieveMockHandler = (overrideResponse?: UserRetrieveResponse | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<UserRetrieveResponse> | UserRetrieveResponse)) => {
  return http.get('*/api/v2/users/:username/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getMeRetrieveMockHandler = (overrideResponse?: MeListResponse | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<MeListResponse> | MeListResponse)) => {
  return http.get('*/me/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getMePartialUpdateMockHandler = (overrideResponse?: MeListResponse | ((info: Parameters<Parameters<typeof http.patch>[1]>[0]) => Promise<MeListResponse> | MeListResponse)) => {
  return http.patch('*/me/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getMeDestroyMockHandler = (overrideResponse?: void | ((info: Parameters<Parameters<typeof http.delete>[1]>[0]) => Promise<void> | void)) => {
  return http.delete('*/me/', async (info) => {if (typeof overrideResponse === 'function') {await overrideResponse(info); }
    return new HttpResponse(null,
      { status: 204,
...
export const getMeEmailsListMockHandler = (overrideResponse?: PaginatedEmailAddressList | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<PaginatedEmailAddressList> | PaginatedEmailAddressList)) => {
  return http.get('*/me/emails/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getMeEmailsCreateMockHandler = (overrideResponse?: EmailAddress | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<EmailAddress> | EmailAddress)) => {
  return http.post('*/me/emails/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getMeSocialAccountsListMockHandler = (overrideResponse?: PaginatedSocialAccountList | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<PaginatedSocialAccountList> | PaginatedSocialAccountList)) => {
  return http.get('*/me/social-accounts/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getMeSocialAccountsRetrieveMockHandler = (overrideResponse?: SocialAccount | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<SocialAccount> | SocialAccount)) => {
  return http.get('*/me/social-accounts/:provider/:uidSocialAccount/', async (info) => {return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
...
export const getMeSocialAccountsDestroyMockHandler = (overrideResponse?: void | ((info: Parameters<Parameters<typeof http.delete>[1]>[0]) => Promise<void> | void)) => {
  return http.delete('*/me/social-accounts/:provider/:uidSocialAccount/', async (info) => {if (typeof overrideResponse === 'function') {await overrideResponse(info); }
    return new HttpResponse(null,
      { status: 204,
