...
export const getApiV2AssetSnapshotsPreviewRetrieveMockHandler = (
  ...
  return http.get(
    '*/api/v2/asset_snapshots/:uidAssetSnapshot/preview{/}?',
    async (info) => {
      if (typeof overrideResponse === 'function') {
        await overrideResponse(info)
      }
...
export const getApiV2AssetSnapshotsXformRetrieveMockHandler = (
  ...
  return http.get(
    '*/api/v2/asset_snapshots/:uidAssetSnapshot/xform{/}?',
    async (info) => {
      return new HttpResponse(
        JSON.stringify(
          overrideResponse !== undefined
...
export const getApiV2AssetSnapshotsXmlWithDisclaimerRetrieveMockHandler = (
  ...
  return http.get(
    '*/api/v2/asset_snapshots/:uidAssetSnapshot/xml_with_disclaimer{/}?',
    async (info) => {
      return new HttpResponse(
        JSON.stringify(
          overrideResponse !== undefined
...
export const getApiV2AssetsContentRetrieveMockHandler = (
  ...
  return http.get(
    '*/api/v2/assets/:uidAsset/content{/}?',
    async (info) => {
      return new HttpResponse(
        JSON.stringify(
          overrideResponse !== undefined
...
export const getApiV2AssetsTableViewRetrieveMockHandler = (
  ...
  return http.get(
    '*/api/v2/assets/:uidAsset/table_view{/}?',
    async (info) => {
      return new HttpResponse(
        JSON.stringify(
          overrideResponse !== undefined
...
export const getApiV2AssetsValidContentRetrieveMockHandler = (
  ...
  return http.get(
    '*/api/v2/assets/:uidAsset/valid_content{/}?',
    async (info) => {
      return new HttpResponse(
        JSON.stringify(
          overrideResponse !== undefined
