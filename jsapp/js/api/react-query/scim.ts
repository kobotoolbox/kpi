...
export const getApiV2ScimV2GroupsListResponseMock = (
  ...
  totalResults: faker.number.int({ min: undefined, max: undefined, multipleOf: undefined }),
  itemsPerPage: faker.number.int({ min: undefined, max: undefined, multipleOf: undefined }),
  startIndex: faker.number.int({ min: undefined, max: undefined, multipleOf: undefined }),
