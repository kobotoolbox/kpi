...
export const getApiV2EnvironmentRetrieveResponseMock = (
  ...
  frontend_min_retry_time: faker.number.int({ min: undefined, max: undefined }),
  frontend_max_retry_time: faker.number.int({ min: undefined, max: undefined }),
  ...
  project_history_log_lifespan: faker.number.int({ min: undefined, max: undefined }),
  ...
  mfa_code_length: faker.number.int({ min: undefined, max: undefined }),
