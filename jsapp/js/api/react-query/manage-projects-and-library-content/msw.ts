...
export const getApiV2AssetsCountsListResponseMock = (
  ...
  results: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
    daily_submission_count: {
      '2020-10-20': faker.helpers.arrayElement([faker.number.int({ min: undefined, max: undefined }), undefined]),
    },
    total_submission_count: faker.number.int({ min: undefined, max: undefined }),
  })),
  ...overrideResponse,
})
    ...
    messages: {
      ...
      'audit-logs': faker.helpers.arrayElement([
        Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
          ...
          asset_id: faker.helpers.arrayElement([faker.number.int({ min: undefined, max: undefined }), undefined]),
...
export const getApiV2AssetsDeploymentRetrieveMockHandler = (
  ...
  return http.get(
    '*/api/v2/assets/:uidAsset/deployment{/}?',
    async (info) => {
      return new HttpResponse(
        JSON.stringify(
          overrideResponse !== undefined
...
export const getApiV2AssetsVersionsRetrieveMockHandler = (
  ...
  return http.get(
    '*/api/v2/assets/:uidAsset/versions/:uidVersion{/}?',
    async (info) => {
      return new HttpResponse(
        JSON.stringify(
          overrideResponse !== undefined
...
export const getApiV2ProjectOwnershipInvitesRetrieveMockHandler = (
  ...
  return http.get(
    '*/api/v2/project-ownership/invites/:uidInvite{/}?',
    async (info) => {
      return new HttpResponse(
        JSON.stringify(
          overrideResponse !== undefined
...
export const getApiV2ProjectOwnershipInvitesTransfersRetrieveMockHandler = (
  ...
  return http.get(
    '*/api/v2/project-ownership/invites/:uidInvite/transfers/:uidTransfer{/}?',
    async (info) => {
      return new HttpResponse(
        JSON.stringify(
          overrideResponse !== undefined
