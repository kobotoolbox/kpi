...
import type {
  AssetBulkRequest
} from '../../models/assetBulkRequest';

import type {
  AssetBulkResponse
} from '../../models/assetBulkResponse';

import type {
  AssetCreateRequest
} from '../../models/assetCreateRequest';
...
import type {
  AssetsCountsListParams
} from '../../models/assetsCountsListParams';

import type {
  AssetsListParams
} from '../../models/assetsListParams';

import type {
  AssetsMinimalListRetrieveParams
} from '../../models/assetsMinimalListRetrieveParams';

import type {
  AssetsRetrieveParams
} from '../../models/assetsRetrieveParams';

import type {
  AssetsVersionsListParams
} from '../../models/assetsVersionsListParams';

import type {
  DeploymentCreateRequest
} from '../../models/deploymentCreateRequest';

import type {
  DeploymentResponse
} from '../../models/deploymentResponse';
...
import type {
  HashResponse
} from '../../models/hashResponse';

import type {
  ImportCreateRequest
} from '../../models/importCreateRequest';

import type {
  ImportCreateResponse
} from '../../models/importCreateResponse';
...
import type {
  ImportsListParams
} from '../../models/importsListParams';

import type {
  PaginatedAssetCountResponseList
} from '../../models/paginatedAssetCountResponseList';
...
} from '../../models/paginatedImportResponseList';

import type {
  PaginatedProjectInviteResponseList
} from '../../models/paginatedProjectInviteResponseList';

import type {
  PaginatedTagListResponseList
} from '../../models/paginatedTagListResponseList';

import type {
  PaginatedVersionListResponseList
} from '../../models/paginatedVersionListResponseList';

import type {
  PatchedAssetPatchRequest
} from '../../models/patchedAssetPatchRequest';

import type {
  PatchedDeploymentPatchRequest
} from '../../models/patchedDeploymentPatchRequest';

import type {
  PatchedInviteUpdatePayload
} from '../../models/patchedInviteUpdatePayload';

import type {
  ProjectInviteCreatePayload
} from '../../models/projectInviteCreatePayload';

import type {
  ProjectInviteResponse
} from '../../models/projectInviteResponse';

import type {
  ProjectOwnershipInvitesListParams
} from '../../models/projectOwnershipInvitesListParams';

import type {
  TagRetrieveResponse
} from '../../models/tagRetrieveResponse';

import type {
  TagsListParams
} from '../../models/tagsListParams';
...
} from '../../models/versionRetrieveResponse';
...
export const getAssetsListQueryOptions = <TData = Awaited<ReturnType<typeof assetsList>>, TError = unknown>(params?: AssetsListParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof assetsList>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getAssetsListQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof assetsList>>> = ({ signal }) => assetsList(params, { signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof assetsList>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useAssetsList<TData = Awaited<ReturnType<typeof assetsList>>, TError = unknown>(
 params?: AssetsListParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof assetsList>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
...
export const assetsCreate = async (assetCreateRequest: AssetCreateRequest, options?: RequestInit): Promise<assetsCreateResponse> => {
...
export const getAssetsCreateMutationOptions = <TError = ErrorObject | ErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof assetsCreate>>, TError,{data: AssetCreateRequest}, TContext>, request?: SecondParameter<typeof fetchWithAuth>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof assetsCreate>>, {data: AssetCreateRequest}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export const useAssetsCreate = <TError = ErrorObject | ErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof assetsCreate>>, TError,{data: AssetCreateRequest}, TContext>, request?: SecondParameter<typeof fetchWithAuth>}
 ) => {
...
export const getAssetsRetrieveUrl = (uidAsset: string,
  ...
  return stringifiedParams.length > 0 ? `/api/v2/assets/${uidAsset}/?${stringifiedParams}` : `/api/v2/assets/${uidAsset}/`
}

export const assetsRetrieve = async (uidAsset: string,
    params?: AssetsRetrieveParams, options?: RequestInit): Promise<assetsRetrieveResponse> => {
...
export const getAssetsRetrieveQueryKey = (uidAsset: string,
    params?: AssetsRetrieveParams,) => {
    return ['api','v2','assets',uidAsset, ...(params ? [params]: [])] as const;
    }

    
export const getAssetsRetrieveQueryOptions = <TData = Awaited<ReturnType<typeof assetsRetrieve>>, TError = ErrorDetail>(uidAsset: string,
    params?: AssetsRetrieveParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof assetsRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getAssetsRetrieveQueryKey(uidAsset,params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof assetsRetrieve>>> = ({ signal }) => assetsRetrieve(uidAsset,params, { signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, enabled: !!(uidAsset), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof assetsRetrieve>>, TError, TData> & { queryKey: QueryKey }
}
...
export type assetsPartialUpdateResponseComposite = assetsPartialUpdateResponse200 | assetsPartialUpdateResponse400 | assetsPartialUpdateResponse401;
...
export const assetsPartialUpdate = async (uidAsset: string,
    patchedAssetPatchRequest: PatchedAssetPatchRequest, options?: RequestInit): Promise<assetsPartialUpdateResponse> => {
...
export const getAssetsPartialUpdateMutationOptions = <TError = ErrorObject | ErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof assetsPartialUpdate>>, TError,{uidAsset: string;data: PatchedAssetPatchRequest}, TContext>, request?: SecondParameter<typeof fetchWithAuth>}
): UseMutationOptions<Awaited<ReturnType<typeof assetsPartialUpdate>>, TError,{uidAsset: string;data: PatchedAssetPatchRequest}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof assetsPartialUpdate>>, {uidAsset: string;data: PatchedAssetPatchRequest}> = (props) => {
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export const useAssetsPartialUpdate = <TError = ErrorObject | ErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof assetsPartialUpdate>>, TError,{uidAsset: string;data: PatchedAssetPatchRequest}, TContext>, request?: SecondParameter<typeof fetchWithAuth>}
 ) => {
...
export const getAssetsDestroyMutationOptions = <TError = ErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof assetsDestroy>>, TError,{uidAsset: string}, TContext>, request?: SecondParameter<typeof fetchWithAuth>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export const useAssetsDestroy = <TError = ErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof assetsDestroy>>, TError,{uidAsset: string}, TContext>, request?: SecondParameter<typeof fetchWithAuth>}
 ) => {
...
export const getAssetsCountsListUrl = (uidAsset: string,
  ...
  return stringifiedParams.length > 0 ? `/api/v2/assets/${uidAsset}/counts/?${stringifiedParams}` : `/api/v2/assets/${uidAsset}/counts/`
}

export const assetsCountsList = async (uidAsset: string,
    params?: AssetsCountsListParams, options?: RequestInit): Promise<assetsCountsListResponse> => {
...
export const getAssetsCountsListQueryKey = (uidAsset: string,
    params?: AssetsCountsListParams,) => {
    return ['api','v2','assets',uidAsset,'counts', ...(params ? [params]: [])] as const;
    }

    
export const getAssetsCountsListQueryOptions = <TData = Awaited<ReturnType<typeof assetsCountsList>>, TError = ErrorDetail>(uidAsset: string,
    params?: AssetsCountsListParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof assetsCountsList>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getAssetsCountsListQueryKey(uidAsset,params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof assetsCountsList>>> = ({ signal }) => assetsCountsList(uidAsset,params, { signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, enabled: !!(uidAsset), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof assetsCountsList>>, TError, TData> & { queryKey: QueryKey }
}
...
export const assetsDeploymentRetrieve = async (uidAsset: string, options?: RequestInit): Promise<assetsDeploymentRetrieveResponse> => {
...
export const getAssetsDeploymentRetrieveQueryOptions = <TData = Awaited<ReturnType<typeof assetsDeploymentRetrieve>>, TError = ErrorDetail>(uidAsset: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof assetsDeploymentRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getAssetsDeploymentRetrieveQueryKey(uidAsset);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof assetsDeploymentRetrieve>>> = ({ signal }) => assetsDeploymentRetrieve(uidAsset, { signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, enabled: !!(uidAsset), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof assetsDeploymentRetrieve>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useAssetsDeploymentRetrieve<TData = Awaited<ReturnType<typeof assetsDeploymentRetrieve>>, TError = ErrorDetail>(
 uidAsset: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof assetsDeploymentRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
...
export type assetsDeploymentCreateResponseComposite = assetsDeploymentCreateResponse200 | assetsDeploymentCreateResponse400 | assetsDeploymentCreateResponse401;
...
export const assetsDeploymentCreate = async (uidAsset: string,
    deploymentCreateRequest: DeploymentCreateRequest, options?: RequestInit): Promise<assetsDeploymentCreateResponse> => {
...
export const getAssetsDeploymentCreateMutationOptions = <TError = ErrorObject | ErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof assetsDeploymentCreate>>, TError,{uidAsset: string;data: DeploymentCreateRequest}, TContext>, request?: SecondParameter<typeof fetchWithAuth>}
): UseMutationOptions<Awaited<ReturnType<typeof assetsDeploymentCreate>>, TError,{uidAsset: string;data: DeploymentCreateRequest}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof assetsDeploymentCreate>>, {uidAsset: string;data: DeploymentCreateRequest}> = (props) => {
          const {uidAsset,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export const useAssetsDeploymentCreate = <TError = ErrorObject | ErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof assetsDeploymentCreate>>, TError,{uidAsset: string;data: DeploymentCreateRequest}, TContext>, request?: SecondParameter<typeof fetchWithAuth>}
 ) => {
...
export type assetsDeploymentPartialUpdateResponseComposite = assetsDeploymentPartialUpdateResponse200 | assetsDeploymentPartialUpdateResponse400 | assetsDeploymentPartialUpdateResponse401;
...
export const assetsDeploymentPartialUpdate = async (uidAsset: string,
    patchedDeploymentPatchRequest: PatchedDeploymentPatchRequest, options?: RequestInit): Promise<assetsDeploymentPartialUpdateResponse> => {
...
export const getAssetsDeploymentPartialUpdateMutationOptions = <TError = ErrorObject | ErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof assetsDeploymentPartialUpdate>>, TError,{uidAsset: string;data: PatchedDeploymentPatchRequest}, TContext>, request?: SecondParameter<typeof fetchWithAuth>}
): UseMutationOptions<Awaited<ReturnType<typeof assetsDeploymentPartialUpdate>>, TError,{uidAsset: string;data: PatchedDeploymentPatchRequest}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof assetsDeploymentPartialUpdate>>, {uidAsset: string;data: PatchedDeploymentPatchRequest}> = (props) => {
          const {uidAsset,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AssetsDeploymentPartialUpdateMutationResult = NonNullable<Awaited<ReturnType<typeof assetsDeploymentPartialUpdate>>>
    ...
    export const useAssetsDeploymentPartialUpdate = <TError = ErrorObject | ErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof assetsDeploymentPartialUpdate>>, TError,{uidAsset: string;data: PatchedDeploymentPatchRequest}, TContext>, request?: SecondParameter<typeof fetchWithAuth>}
 ) => {
...
export const getAssetsVersionsListUrl = (uidAsset: string,
  ...
  return stringifiedParams.length > 0 ? `/api/v2/assets/${uidAsset}/versions/?${stringifiedParams}` : `/api/v2/assets/${uidAsset}/versions/`
}

export const assetsVersionsList = async (uidAsset: string,
    params?: AssetsVersionsListParams, options?: RequestInit): Promise<assetsVersionsListResponse> => {
...
export const getAssetsVersionsListQueryKey = (uidAsset: string,
    params?: AssetsVersionsListParams,) => {
    return ['api','v2','assets',uidAsset,'versions', ...(params ? [params]: [])] as const;
    }

    
export const getAssetsVersionsListQueryOptions = <TData = Awaited<ReturnType<typeof assetsVersionsList>>, TError = ErrorDetail>(uidAsset: string,
    params?: AssetsVersionsListParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof assetsVersionsList>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getAssetsVersionsListQueryKey(uidAsset,params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof assetsVersionsList>>> = ({ signal }) => assetsVersionsList(uidAsset,params, { signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, enabled: !!(uidAsset), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof assetsVersionsList>>, TError, TData> & { queryKey: QueryKey }
}
...
export type assetsVersionsRetrieveResponseComposite = assetsVersionsRetrieveResponse200 | assetsVersionsRetrieveResponse404;
    
export type assetsVersionsRetrieveResponse = assetsVersionsRetrieveResponseComposite & {
  headers: Headers;
}

export const getAssetsVersionsRetrieveUrl = (uidAsset: string,
    uidVersion: string,) => {
...
export const assetsVersionsRetrieve = async (uidAsset: string,
    uidVersion: string, options?: RequestInit): Promise<assetsVersionsRetrieveResponse> => {
...
export const getAssetsVersionsRetrieveQueryKey = (uidAsset: string,
    uidVersion: string,) => {
    return ['api','v2','assets',uidAsset,'versions',uidVersion] as const;
    }

    
export const getAssetsVersionsRetrieveQueryOptions = <TData = Awaited<ReturnType<typeof assetsVersionsRetrieve>>, TError = ErrorDetail>(uidAsset: string,
    uidVersion: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof assetsVersionsRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getAssetsVersionsRetrieveQueryKey(uidAsset,uidVersion);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof assetsVersionsRetrieve>>> = ({ signal }) => assetsVersionsRetrieve(uidAsset,uidVersion, { signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, enabled: !!(uidAsset && uidVersion), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof assetsVersionsRetrieve>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useAssetsVersionsRetrieve<TData = Awaited<ReturnType<typeof assetsVersionsRetrieve>>, TError = ErrorDetail>(
 uidAsset: string,
    uidVersion: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof assetsVersionsRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
...
export const assetsXformRetrieve = async (uidAsset: string, options?: RequestInit): Promise<assetsXformRetrieveResponse> => {
...
export const getAssetsXformRetrieveQueryOptions = <TData = Awaited<ReturnType<typeof assetsXformRetrieve>>, TError = void>(uidAsset: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof assetsXformRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getAssetsXformRetrieveQueryKey(uidAsset);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof assetsXformRetrieve>>> = ({ signal }) => assetsXformRetrieve(uidAsset, { signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, enabled: !!(uidAsset), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof assetsXformRetrieve>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useAssetsXformRetrieve<TData = Awaited<ReturnType<typeof assetsXformRetrieve>>, TError = void>(
 uidAsset: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof assetsXformRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
...
export const assetsBulkCreate = async (assetBulkRequest: AssetBulkRequest, options?: RequestInit): Promise<assetsBulkCreateResponse> => {
...
export const getAssetsBulkCreateMutationOptions = <TError = ErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof assetsBulkCreate>>, TError,{data: AssetBulkRequest}, TContext>, request?: SecondParameter<typeof fetchWithAuth>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof assetsBulkCreate>>, {data: AssetBulkRequest}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export const useAssetsBulkCreate = <TError = ErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof assetsBulkCreate>>, TError,{data: AssetBulkRequest}, TContext>, request?: SecondParameter<typeof fetchWithAuth>}
 ) => {
...
export const getAssetsCountsRetrieveQueryOptions = <TData = Awaited<ReturnType<typeof assetsCountsRetrieve>>, TError = unknown>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof assetsCountsRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getAssetsCountsRetrieveQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof assetsCountsRetrieve>>> = ({ signal }) => assetsCountsRetrieve({ signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof assetsCountsRetrieve>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useAssetsCountsRetrieve<TData = Awaited<ReturnType<typeof assetsCountsRetrieve>>, TError = unknown>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof assetsCountsRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
...
export const getAssetsHashRetrieveQueryOptions = <TData = Awaited<ReturnType<typeof assetsHashRetrieve>>, TError = ErrorDetail>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof assetsHashRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getAssetsHashRetrieveQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof assetsHashRetrieve>>> = ({ signal }) => assetsHashRetrieve({ signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof assetsHashRetrieve>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useAssetsHashRetrieve<TData = Awaited<ReturnType<typeof assetsHashRetrieve>>, TError = ErrorDetail>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof assetsHashRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
...
export const getAssetsMetadataRetrieveQueryOptions = <TData = Awaited<ReturnType<typeof assetsMetadataRetrieve>>, TError = unknown>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof assetsMetadataRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getAssetsMetadataRetrieveQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof assetsMetadataRetrieve>>> = ({ signal }) => assetsMetadataRetrieve({ signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof assetsMetadataRetrieve>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useAssetsMetadataRetrieve<TData = Awaited<ReturnType<typeof assetsMetadataRetrieve>>, TError = unknown>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof assetsMetadataRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
...
export const getAssetsMinimalListRetrieveUrl = (params?: AssetsMinimalListRetrieveParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/api/v2/assets/minimal-list/?${stringifiedParams}` : `/api/v2/assets/minimal-list/`
}

export const assetsMinimalListRetrieve = async (params?: AssetsMinimalListRetrieveParams, options?: RequestInit): Promise<assetsMinimalListRetrieveResponse> => {
...
export const getAssetsMinimalListRetrieveQueryOptions = <TData = Awaited<ReturnType<typeof assetsMinimalListRetrieve>>, TError = unknown>(params?: AssetsMinimalListRetrieveParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof assetsMinimalListRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getAssetsMinimalListRetrieveQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof assetsMinimalListRetrieve>>> = ({ signal }) => assetsMinimalListRetrieve(params, { signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof assetsMinimalListRetrieve>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useAssetsMinimalListRetrieve<TData = Awaited<ReturnType<typeof assetsMinimalListRetrieve>>, TError = unknown>(
 params?: AssetsMinimalListRetrieveParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof assetsMinimalListRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
...
export const getImportsListQueryOptions = <TData = Awaited<ReturnType<typeof importsList>>, TError = ErrorDetail>(params?: ImportsListParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof importsList>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getImportsListQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof importsList>>> = ({ signal }) => importsList(params, { signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof importsList>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useImportsList<TData = Awaited<ReturnType<typeof importsList>>, TError = ErrorDetail>(
 params?: ImportsListParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof importsList>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
...
export type importsCreateResponseComposite = importsCreateResponse201 | importsCreateResponse400 | importsCreateResponse401;
...
export const importsCreate = async (importCreateRequest: ImportCreateRequest, options?: RequestInit): Promise<importsCreateResponse> => {
...
export const getImportsCreateMutationOptions = <TError = ErrorObject | ErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof importsCreate>>, TError,{data: ImportCreateRequest}, TContext>, request?: SecondParameter<typeof fetchWithAuth>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof importsCreate>>, {data: ImportCreateRequest}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export const useImportsCreate = <TError = ErrorObject | ErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof importsCreate>>, TError,{data: ImportCreateRequest}, TContext>, request?: SecondParameter<typeof fetchWithAuth>}
 ) => {
...
export const getImportsRetrieveQueryOptions = <TData = Awaited<ReturnType<typeof importsRetrieve>>, TError = ErrorDetail>(uidImport: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof importsRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getImportsRetrieveQueryKey(uidImport);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof importsRetrieve>>> = ({ signal }) => importsRetrieve(uidImport, { signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, enabled: !!(uidImport), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof importsRetrieve>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useImportsRetrieve<TData = Awaited<ReturnType<typeof importsRetrieve>>, TError = ErrorDetail>(
 uidImport: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof importsRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
...
export type projectOwnershipInvitesListResponseComposite = projectOwnershipInvitesListResponse200 | projectOwnershipInvitesListResponse403;
...
export const getProjectOwnershipInvitesListUrl = (params?: ProjectOwnershipInvitesListParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/api/v2/project-ownership/invites/?${stringifiedParams}` : `/api/v2/project-ownership/invites/`
}

export const projectOwnershipInvitesList = async (params?: ProjectOwnershipInvitesListParams, options?: RequestInit): Promise<projectOwnershipInvitesListResponse> => {
...
export const getProjectOwnershipInvitesListQueryOptions = <TData = Awaited<ReturnType<typeof projectOwnershipInvitesList>>, TError = ErrorDetail>(params?: ProjectOwnershipInvitesListParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof projectOwnershipInvitesList>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getProjectOwnershipInvitesListQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof projectOwnershipInvitesList>>> = ({ signal }) => projectOwnershipInvitesList(params, { signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof projectOwnershipInvitesList>>, TError, TData> & { queryKey: QueryKey }
}

export type ProjectOwnershipInvitesListQueryResult = NonNullable<Awaited<ReturnType<typeof projectOwnershipInvitesList>>>
export type ProjectOwnershipInvitesListQueryError = ErrorDetail



export function useProjectOwnershipInvitesList<TData = Awaited<ReturnType<typeof projectOwnershipInvitesList>>, TError = ErrorDetail>(
 params?: ProjectOwnershipInvitesListParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof projectOwnershipInvitesList>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
...
export type projectOwnershipInvitesCreateResponseComposite = projectOwnershipInvitesCreateResponse201 | projectOwnershipInvitesCreateResponse400 | projectOwnershipInvitesCreateResponse403;
...
export const projectOwnershipInvitesCreate = async (projectInviteCreatePayload: ProjectInviteCreatePayload, options?: RequestInit): Promise<projectOwnershipInvitesCreateResponse> => {
...
export const getProjectOwnershipInvitesCreateMutationOptions = <TError = ErrorObject | ErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof projectOwnershipInvitesCreate>>, TError,{data: ProjectInviteCreatePayload}, TContext>, request?: SecondParameter<typeof fetchWithAuth>}
): UseMutationOptions<Awaited<ReturnType<typeof projectOwnershipInvitesCreate>>, TError,{data: ProjectInviteCreatePayload}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof projectOwnershipInvitesCreate>>, {data: ProjectInviteCreatePayload}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ProjectOwnershipInvitesCreateMutationResult = NonNullable<Awaited<ReturnType<typeof projectOwnershipInvitesCreate>>>
    ...
    export const useProjectOwnershipInvitesCreate = <TError = ErrorObject | ErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof projectOwnershipInvitesCreate>>, TError,{data: ProjectInviteCreatePayload}, TContext>, request?: SecondParameter<typeof fetchWithAuth>}
 ) => {
...
export type projectOwnershipInvitesRetrieveResponseComposite = projectOwnershipInvitesRetrieveResponse200 | projectOwnershipInvitesRetrieveResponse403;
...
export const projectOwnershipInvitesRetrieve = async (uidInvite: string, options?: RequestInit): Promise<projectOwnershipInvitesRetrieveResponse> => {
...
export const getProjectOwnershipInvitesRetrieveQueryOptions = <TData = Awaited<ReturnType<typeof projectOwnershipInvitesRetrieve>>, TError = ErrorDetail>(uidInvite: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof projectOwnershipInvitesRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getProjectOwnershipInvitesRetrieveQueryKey(uidInvite);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof projectOwnershipInvitesRetrieve>>> = ({ signal }) => projectOwnershipInvitesRetrieve(uidInvite, { signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, enabled: !!(uidInvite), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof projectOwnershipInvitesRetrieve>>, TError, TData> & { queryKey: QueryKey }
}

export type ProjectOwnershipInvitesRetrieveQueryResult = NonNullable<Awaited<ReturnType<typeof projectOwnershipInvitesRetrieve>>>
export type ProjectOwnershipInvitesRetrieveQueryError = ErrorDetail



export function useProjectOwnershipInvitesRetrieve<TData = Awaited<ReturnType<typeof projectOwnershipInvitesRetrieve>>, TError = ErrorDetail>(
 uidInvite: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof projectOwnershipInvitesRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
...
export type projectOwnershipInvitesPartialUpdateResponseComposite = projectOwnershipInvitesPartialUpdateResponse200 | projectOwnershipInvitesPartialUpdateResponse400 | projectOwnershipInvitesPartialUpdateResponse403;
...
export const projectOwnershipInvitesPartialUpdate = async (uidInvite: string,
    patchedInviteUpdatePayload: PatchedInviteUpdatePayload, options?: RequestInit): Promise<projectOwnershipInvitesPartialUpdateResponse> => {
  
  return fetchWithAuth<projectOwnershipInvitesPartialUpdateResponse>(getProjectOwnershipInvitesPartialUpdateUrl(uidInvite),
  {      
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getProjectOwnershipInvitesPartialUpdateMutationOptions = <TError = ErrorObject | ErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof projectOwnershipInvitesPartialUpdate>>, TError,{uidInvite: string;data: PatchedInviteUpdatePayload}, TContext>, request?: SecondParameter<typeof fetchWithAuth>}
): UseMutationOptions<Awaited<ReturnType<typeof projectOwnershipInvitesPartialUpdate>>, TError,{uidInvite: string;data: PatchedInviteUpdatePayload}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof projectOwnershipInvitesPartialUpdate>>, {uidInvite: string;data: PatchedInviteUpdatePayload}> = (props) => {
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ProjectOwnershipInvitesPartialUpdateMutationResult = NonNullable<Awaited<ReturnType<typeof projectOwnershipInvitesPartialUpdate>>>
    ...
    export const useProjectOwnershipInvitesPartialUpdate = <TError = ErrorObject | ErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof projectOwnershipInvitesPartialUpdate>>, TError,{uidInvite: string;data: PatchedInviteUpdatePayload}, TContext>, request?: SecondParameter<typeof fetchWithAuth>}
 ) => {
...
export type projectOwnershipInvitesDestroyResponseComposite = projectOwnershipInvitesDestroyResponse204 | projectOwnershipInvitesDestroyResponse403;
...
export const projectOwnershipInvitesDestroy = async (uidInvite: string, options?: RequestInit): Promise<projectOwnershipInvitesDestroyResponse> => {
...
export const getProjectOwnershipInvitesDestroyMutationOptions = <TError = ErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof projectOwnershipInvitesDestroy>>, TError,{uidInvite: string}, TContext>, request?: SecondParameter<typeof fetchWithAuth>}
): UseMutationOptions<Awaited<ReturnType<typeof projectOwnershipInvitesDestroy>>, TError,{uidInvite: string}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof projectOwnershipInvitesDestroy>>, {uidInvite: string}> = (props) => {
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ProjectOwnershipInvitesDestroyMutationResult = NonNullable<Awaited<ReturnType<typeof projectOwnershipInvitesDestroy>>>
    
    export type ProjectOwnershipInvitesDestroyMutationError = ErrorDetail

    export const useProjectOwnershipInvitesDestroy = <TError = ErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof projectOwnershipInvitesDestroy>>, TError,{uidInvite: string}, TContext>, request?: SecondParameter<typeof fetchWithAuth>}
 ) => {
...
export type projectOwnershipInvitesTransfersRetrieveResponseComposite = projectOwnershipInvitesTransfersRetrieveResponse200 | projectOwnershipInvitesTransfersRetrieveResponse401;
    
export type projectOwnershipInvitesTransfersRetrieveResponse = projectOwnershipInvitesTransfersRetrieveResponseComposite & {
  headers: Headers;
}

export const getProjectOwnershipInvitesTransfersRetrieveUrl = (uidInvite: string,
    uidTransfer: string,) => {
...
export const projectOwnershipInvitesTransfersRetrieve = async (uidInvite: string,
    uidTransfer: string, options?: RequestInit): Promise<projectOwnershipInvitesTransfersRetrieveResponse> => {
  
  return fetchWithAuth<projectOwnershipInvitesTransfersRetrieveResponse>(getProjectOwnershipInvitesTransfersRetrieveUrl(uidInvite,uidTransfer),
  {      
    ...options,
    method: 'GET'
...
export const getProjectOwnershipInvitesTransfersRetrieveQueryKey = (uidInvite: string,
    uidTransfer: string,) => {
    return ['api','v2','project-ownership','invites',uidInvite,'transfers',uidTransfer] as const;
    }

    
export const getProjectOwnershipInvitesTransfersRetrieveQueryOptions = <TData = Awaited<ReturnType<typeof projectOwnershipInvitesTransfersRetrieve>>, TError = ErrorDetail>(uidInvite: string,
    uidTransfer: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof projectOwnershipInvitesTransfersRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getProjectOwnershipInvitesTransfersRetrieveQueryKey(uidInvite,uidTransfer);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof projectOwnershipInvitesTransfersRetrieve>>> = ({ signal }) => projectOwnershipInvitesTransfersRetrieve(uidInvite,uidTransfer, { signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, enabled: !!(uidInvite && uidTransfer), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof projectOwnershipInvitesTransfersRetrieve>>, TError, TData> & { queryKey: QueryKey }
}

export type ProjectOwnershipInvitesTransfersRetrieveQueryResult = NonNullable<Awaited<ReturnType<typeof projectOwnershipInvitesTransfersRetrieve>>>
export type ProjectOwnershipInvitesTransfersRetrieveQueryError = ErrorDetail



export function useProjectOwnershipInvitesTransfersRetrieve<TData = Awaited<ReturnType<typeof projectOwnershipInvitesTransfersRetrieve>>, TError = ErrorDetail>(
 uidInvite: string,
    uidTransfer: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof projectOwnershipInvitesTransfersRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
...
export const getTagsListQueryOptions = <TData = Awaited<ReturnType<typeof tagsList>>, TError = ErrorDetail>(params?: TagsListParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof tagsList>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getTagsListQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof tagsList>>> = ({ signal }) => tagsList(params, { signal, ...requestOptions });
...
export function useTagsList<TData = Awaited<ReturnType<typeof tagsList>>, TError = ErrorDetail>(
 params?: TagsListParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof tagsList>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
...
export const getTagsRetrieveQueryOptions = <TData = Awaited<ReturnType<typeof tagsRetrieve>>, TError = ErrorDetail>(taguidUid: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof tagsRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getTagsRetrieveQueryKey(taguidUid);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof tagsRetrieve>>> = ({ signal }) => tagsRetrieve(taguidUid, { signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, enabled: !!(taguidUid), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof tagsRetrieve>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useTagsRetrieve<TData = Awaited<ReturnType<typeof tagsRetrieve>>, TError = ErrorDetail>(
 taguidUid: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof tagsRetrieve>>, TError, TData>, request?: SecondParameter<typeof fetchWithAuth>}
