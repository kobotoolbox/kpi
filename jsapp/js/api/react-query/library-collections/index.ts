...
export type assetSubscriptionsListResponseSuccess = assetSubscriptionsListResponse200 & {
  headers: Headers
}

export type assetSubscriptionsListResponse = assetSubscriptionsListResponseSuccess
...
export type assetSubscriptionsCreateResponseSuccess = assetSubscriptionsCreateResponse201 & {
  headers: Headers
}
export type assetSubscriptionsCreateResponseError = assetSubscriptionsCreateResponse400 & {
  headers: Headers
}

export type assetSubscriptionsCreateResponse =
  | assetSubscriptionsCreateResponseSuccess
  | assetSubscriptionsCreateResponseError
...
export type assetSubscriptionsRetrieveResponseSuccess = assetSubscriptionsRetrieveResponse200 & {
  headers: Headers
}
export type assetSubscriptionsRetrieveResponseError = assetSubscriptionsRetrieveResponse404 & {
  headers: Headers
}

export type assetSubscriptionsRetrieveResponse =
  | assetSubscriptionsRetrieveResponseSuccess
  | assetSubscriptionsRetrieveResponseError
...
export type assetSubscriptionsDestroyResponseSuccess = assetSubscriptionsDestroyResponse204 & {
  headers: Headers
}
export type assetSubscriptionsDestroyResponseError = assetSubscriptionsDestroyResponse404 & {
  headers: Headers
}

export type assetSubscriptionsDestroyResponse =
  | assetSubscriptionsDestroyResponseSuccess
  | assetSubscriptionsDestroyResponseError
