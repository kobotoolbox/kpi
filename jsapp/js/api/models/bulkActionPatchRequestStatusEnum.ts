 ...
 * * `cancelled` - cancelled
 */
export type BulkActionPatchRequestStatusEnum =
  (typeof BulkActionPatchRequestStatusEnum)[keyof typeof BulkActionPatchRequestStatusEnum]

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const BulkActionPatchRequestStatusEnum = {
  cancelled: 'cancelled',
} as const
