import type { AssetAdvancedFeaturesQualQualSurveyItemChoicesItem } from './assetAdvancedFeaturesQualQualSurveyItemChoicesItem'
/**
 ...
 */
import type { AssetAdvancedFeaturesQualQualSurveyItemLabels } from './assetAdvancedFeaturesQualQualSurveyItemLabels'
import type { AssetAdvancedFeaturesQualQualSurveyItemOptions } from './assetAdvancedFeaturesQualQualSurveyItemOptions'

export type AssetAdvancedFeaturesQualQualSurveyItem = {
  type: string
  labels: AssetAdvancedFeaturesQualQualSurveyItemLabels
  uuid?: string
  options?: AssetAdvancedFeaturesQualQualSurveyItemOptions
  xpath: string
  scope: string
  choices?: AssetAdvancedFeaturesQualQualSurveyItemChoicesItem[]
}
