import type { MemberListResponse } from './memberListResponse'
/**
 ...
 */
import type { PaginatedMemberListResponseListNext } from './paginatedMemberListResponseListNext'
import type { PaginatedMemberListResponseListPrevious } from './paginatedMemberListResponseListPrevious'

export interface PaginatedMemberListResponseList {
  count: number
  /** @nullable */
  next?: PaginatedMemberListResponseListNext
  /** @nullable */
  previous?: PaginatedMemberListResponseListPrevious
  results: MemberListResponse[]
}
