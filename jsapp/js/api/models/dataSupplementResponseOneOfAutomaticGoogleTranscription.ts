 ...
 */
import type { _DataSupplementResponseOneOfAutomaticGoogleTranscriptionVersionsItem } from './_dataSupplementResponseOneOfAutomaticGoogleTranscriptionVersionsItem'

export type DataSupplementResponseOneOfAutomaticGoogleTranscription = {
  _dateCreated: string
  _dateModified: string
  /** @minLength 1 */
  _versions: _DataSupplementResponseOneOfAutomaticGoogleTranscriptionVersionsItem[]
}
