import type { AssetCountResponse } from './assetCountResponse'
/**
 ...
 */
import type { PaginatedAssetCountResponseListNext } from './paginatedAssetCountResponseListNext'
import type { PaginatedAssetCountResponseListPrevious } from './paginatedAssetCountResponseListPrevious'

export interface PaginatedAssetCountResponseList {
  count: number
  /** @nullable */
  next?: PaginatedAssetCountResponseListNext
  /** @nullable */
  previous?: PaginatedAssetCountResponseListPrevious
  results: AssetCountResponse[]
}
