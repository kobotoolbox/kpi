 ...
 */
import type { AssetsExportSettingsDataRetrieveFormat } from './assetsExportSettingsDataRetrieveFormat'

export type AssetsExportSettingsDataRetrieveParams = {
  format: AssetsExportSettingsDataRetrieveFormat
}
