 ...
 */
import type { SupplementalDataManualQualItem } from './supplementalDataManualQualItem'

/**
 * Map of manual qualitative question UUIDs to their action objects
 */
export interface SupplementalDataManualQual {
  [key: string]: SupplementalDataManualQualItem
}
