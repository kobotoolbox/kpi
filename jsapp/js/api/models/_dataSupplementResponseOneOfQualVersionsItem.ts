 ...
 */
import type { _DataSupplementResponseOneOfQualVersionsItemData } from './_dataSupplementResponseOneOfQualVersionsItemData'

export type _DataSupplementResponseOneOfQualVersionsItem = {
  _data: _DataSupplementResponseOneOfQualVersionsItemData
