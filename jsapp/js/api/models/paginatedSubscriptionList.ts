 ...
 */
import type { PaginatedSubscriptionListNext } from './paginatedSubscriptionListNext'
import type { PaginatedSubscriptionListPrevious } from './paginatedSubscriptionListPrevious'
import type { Subscription } from './subscription'

export interface PaginatedSubscriptionList {
  count: number
  /** @nullable */
  next?: PaginatedSubscriptionListNext
  /** @nullable */
  previous?: PaginatedSubscriptionListPrevious
