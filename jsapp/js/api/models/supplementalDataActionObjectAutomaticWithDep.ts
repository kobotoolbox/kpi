 ...
 */
import type { SupplementalDataVersionItemAutomaticWithDep } from './supplementalDataVersionItemAutomaticWithDep'

export interface SupplementalDataActionObjectAutomaticWithDep {
  _dateCreated: string
  _dateModified: string
  /** @minLength 1 */
  _versions: SupplementalDataVersionItemAutomaticWithDep[]
}
