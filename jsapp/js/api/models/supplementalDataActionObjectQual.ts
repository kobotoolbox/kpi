 ...
 */
import type { SupplementalDataVersionItemQual } from './supplementalDataVersionItemQual'

export interface SupplementalDataActionObjectQual {
  _dateCreated: string
  _dateModified: string
  /** @minLength 1 */
  _versions: SupplementalDataVersionItemQual[]
}
