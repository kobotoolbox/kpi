 ...
 */
import type { _SupplementalDetailsManualTranslationManualTranslationVersionsItem } from './_supplementalDetailsManualTranslationManualTranslationVersionsItem'

/**
 * Map of language codes to translation objects
 */
export type SupplementalDetailsManualTranslationManualTranslation = {
  [key: string]: {
    _dateCreated: string
    _dateModified: string
    /** @minLength 1 */
    _versions: _SupplementalDetailsManualTranslationManualTranslationVersionsItem[]
  }
}
