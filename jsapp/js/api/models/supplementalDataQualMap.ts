 ...
 */
import type { SupplementalDataActionObjectQual } from './supplementalDataActionObjectQual'

/**
 * Map of qualitative question UUIDs to their action objects
 */
export interface SupplementalDataQualMap {
  [key: string]: SupplementalDataActionObjectQual
}
