 ...
 */
import type { PaginatedTranscriptionServiceListNext } from './paginatedTranscriptionServiceListNext'
import type { PaginatedTranscriptionServiceListPrevious } from './paginatedTranscriptionServiceListPrevious'
import type { TranscriptionService } from './transcriptionService'

export interface PaginatedTranscriptionServiceList {
  count: number
  /** @nullable */
  next?: PaginatedTranscriptionServiceListNext
  /** @nullable */
  previous?: PaginatedTranscriptionServiceListPrevious
  results: TranscriptionService[]
}
