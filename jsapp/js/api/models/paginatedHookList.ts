 ...
 */
import type { PaginatedHookListNext } from './paginatedHookListNext'
import type { PaginatedHookListPrevious } from './paginatedHookListPrevious'

export interface PaginatedHookList {
  count: number
  /** @nullable */
  next?: PaginatedHookListNext
  /** @nullable */
  previous?: PaginatedHookListPrevious
  results: Hook[]
}
