 ...
 */
import type { PaginatedHistoryListResponseListNext } from './paginatedHistoryListResponseListNext'
import type { PaginatedHistoryListResponseListPrevious } from './paginatedHistoryListResponseListPrevious'

export interface PaginatedHistoryListResponseList {
  count: number
  /** @nullable */
  next?: PaginatedHistoryListResponseListNext
  /** @nullable */
  previous?: PaginatedHistoryListResponseListPrevious
