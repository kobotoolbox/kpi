...
import type { PatchedDataSupplementPayloadOneOfOneOfQualOneOfFive } from './patchedDataSupplementPayloadOneOfOneOfQualOneOfFive'
import type { PatchedDataSupplementPayloadOneOfOneOfQualOneOfNine } from './patchedDataSupplementPayloadOneOfOneOfQualOneOfNine'
import type { PatchedDataSupplementPayloadOneOfOneOfQualOneOfOneseven } from './patchedDataSupplementPayloadOneOfOneOfQualOneOfOneseven'
import type { PatchedDataSupplementPayloadOneOfOneOfQualOneOfOnethree } from './patchedDataSupplementPayloadOneOfOneOfQualOneOfOnethree'

export type PatchedDataSupplementPayloadOneOfOneOfQual =
  | PatchedDataSupplementPayloadOneOfOneOfQualOneOf
  | PatchedDataSupplementPayloadOneOfOneOfQualOneOfFive
  | PatchedDataSupplementPayloadOneOfOneOfQualOneOfNine
  | PatchedDataSupplementPayloadOneOfOneOfQualOneOfOnethree
