import type { PatchedScimUserMeta } from './patchedScimUserMeta'
/**
 ...
 */
import type { PatchedScimUserName } from './patchedScimUserName'

/**
 * Serializes a Django User to match the SCIM 2.0 User schema.
 */
export interface PatchedScimUser {
  readonly schemas?: unknown
  readonly id?: string
  userName?: string
  readonly name?: PatchedScimUserName
  readonly emails?: unknown
  active?: boolean
  readonly meta?: PatchedScimUserMeta
}
