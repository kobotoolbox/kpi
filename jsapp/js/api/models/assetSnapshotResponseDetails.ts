 ...
 */
import type { AssetSnapshotResponseDetailsWarningsItem } from './assetSnapshotResponseDetailsWarningsItem'

export type AssetSnapshotResponseDetails = {
  status?: string
  warnings?: AssetSnapshotResponseDetailsWarningsItem[]
}
