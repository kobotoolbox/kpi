 ...
 */
import type { ProjectHistoryLogResponseMetadata } from './projectHistoryLogResponseMetadata'

export interface ProjectHistoryLogResponse {
  user: string
  user_uid: string
  username: string
  action: string
  metadata: ProjectHistoryLogResponseMetadata
  date_created: string
}
