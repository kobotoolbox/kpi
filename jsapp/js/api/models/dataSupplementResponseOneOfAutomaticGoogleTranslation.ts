 ...
 */
import type { _DataSupplementResponseOneOfAutomaticGoogleTranslationVersionsItem } from './_dataSupplementResponseOneOfAutomaticGoogleTranslationVersionsItem'

export type DataSupplementResponseOneOfAutomaticGoogleTranslation = {
  [key: string]: {
    _dateCreated: string
    _dateModified: string
    /** @minLength 1 */
    _versions: _DataSupplementResponseOneOfAutomaticGoogleTranslationVersionsItem[]
  }
}
