 ...
 */
import type { PaginatedProductListNext } from './paginatedProductListNext'
import type { PaginatedProductListPrevious } from './paginatedProductListPrevious'
import type { Product } from './product'

export interface PaginatedProductList {
  count: number
  /** @nullable */
  next?: PaginatedProductListNext
  /** @nullable */
  previous?: PaginatedProductListPrevious
  results: Product[]
}
