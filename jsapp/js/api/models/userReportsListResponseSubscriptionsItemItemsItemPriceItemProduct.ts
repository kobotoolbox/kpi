 ...
 */
import type { UserReportsListResponseSubscriptionsItemItemsItemPriceItemProductMetadata } from './userReportsListResponseSubscriptionsItemItemsItemPriceItemProductMetadata'

export type UserReportsListResponseSubscriptionsItemItemsItemPriceItemProduct = {
  id?: string
  name?: string
  description?: string
  type?: string
  metadata?: UserReportsListResponseSubscriptionsItemItemsItemPriceItemProductMetadata
}
