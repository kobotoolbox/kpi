 ...
 */
import type { QualAutomaticStatusEnum } from './qualAutomaticStatusEnum'

export interface DataSupplementAutomaticQualDataSelectMultipleResponse {
  value?: string[]
  status: QualAutomaticStatusEnum
  error?: string
  uuid: string
}
