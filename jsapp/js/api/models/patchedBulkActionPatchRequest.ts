 ...
 */
import type { BulkActionPatchRequestStatusEnum } from './bulkActionPatchRequestStatusEnum'

export interface PatchedBulkActionPatchRequest {
  status?: BulkActionPatchRequestStatusEnum
}
