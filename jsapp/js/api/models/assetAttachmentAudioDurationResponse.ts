 ...
 */
import type { AssetAttachmentAudioDurationItem } from './assetAttachmentAudioDurationItem'

export interface AssetAttachmentAudioDurationResponse {
  attachments: AssetAttachmentAudioDurationItem[]
  total: number
}
