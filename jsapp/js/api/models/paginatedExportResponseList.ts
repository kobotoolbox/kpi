 ...
 */
import type { PaginatedExportResponseListNext } from './paginatedExportResponseListNext'
import type { PaginatedExportResponseListPrevious } from './paginatedExportResponseListPrevious'

export interface PaginatedExportResponseList {
  count: number
  /** @nullable */
  next?: PaginatedExportResponseListNext
  /** @nullable */
  previous?: PaginatedExportResponseListPrevious
