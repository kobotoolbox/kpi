 ...
 */
import type { PaginatedCustomAssetUsageListNext } from './paginatedCustomAssetUsageListNext'
import type { PaginatedCustomAssetUsageListPrevious } from './paginatedCustomAssetUsageListPrevious'

export interface PaginatedCustomAssetUsageList {
  count: number
  /** @nullable */
  next?: PaginatedCustomAssetUsageListNext
  /** @nullable */
  previous?: PaginatedCustomAssetUsageListPrevious
