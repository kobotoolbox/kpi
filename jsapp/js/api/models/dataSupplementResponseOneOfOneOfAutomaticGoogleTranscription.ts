 ...
 */
import type { _DataSupplementResponseOneOfOneOfAutomaticGoogleTranscriptionVersionsItem } from './_dataSupplementResponseOneOfOneOfAutomaticGoogleTranscriptionVersionsItem'

export type DataSupplementResponseOneOfOneOfAutomaticGoogleTranscription = {
  _dateCreated: string
  _dateModified: string
  /** @minLength 1 */
  _versions: _DataSupplementResponseOneOfOneOfAutomaticGoogleTranscriptionVersionsItem[]
}
