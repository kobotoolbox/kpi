 ...
 */
import type { PermissionAssignmentCreateRequestOneOfTwoPartialPermissionItem } from './permissionAssignmentCreateRequestOneOfTwoPartialPermissionItem'

export type PermissionAssignmentCreateRequestOneOfTwo = {
  partial_permission: PermissionAssignmentCreateRequestOneOfTwoPartialPermissionItem[]
  permission: string
  user: string
}
