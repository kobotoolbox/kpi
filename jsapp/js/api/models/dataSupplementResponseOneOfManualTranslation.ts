 ...
 */
import type { _DataSupplementResponseOneOfManualTranslationVersionsItem } from './_dataSupplementResponseOneOfManualTranslationVersionsItem'

export type DataSupplementResponseOneOfManualTranslation = {
  [key: string]: {
    _dateCreated: string
    _dateModified: string
    /** @minLength 1 */
    _versions: _DataSupplementResponseOneOfManualTranslationVersionsItem[]
  }
}
