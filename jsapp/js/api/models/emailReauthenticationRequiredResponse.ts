 ...
 */
import type { EmailReauthenticationRequiredResponseFlowsItem } from './emailReauthenticationRequiredResponseFlowsItem'

export interface EmailReauthenticationRequiredResponse {
  detail: string
  code: string
  flows: EmailReauthenticationRequiredResponseFlowsItem[]
}
