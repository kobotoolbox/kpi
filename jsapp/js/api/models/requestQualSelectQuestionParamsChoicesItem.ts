...
import type { RequestQualSelectQuestionParamsChoicesItemHint } from './requestQualSelectQuestionParamsChoicesItemHint'
import type { RequestQualSelectQuestionParamsChoicesItemLabels } from './requestQualSelectQuestionParamsChoicesItemLabels'

export type RequestQualSelectQuestionParamsChoicesItem = {
  labels: RequestQualSelectQuestionParamsChoicesItemLabels
  uuid: string
  hint?: RequestQualSelectQuestionParamsChoicesItemHint
}
