 ...
 */
import type { PaginatedProjectViewAssetResponseListNext } from './paginatedProjectViewAssetResponseListNext'
import type { PaginatedProjectViewAssetResponseListPrevious } from './paginatedProjectViewAssetResponseListPrevious'
import type { ProjectViewAssetResponse } from './projectViewAssetResponse'

export interface PaginatedProjectViewAssetResponseList {
  count: number
  /** @nullable */
  next?: PaginatedProjectViewAssetResponseListNext
  /** @nullable */
  previous?: PaginatedProjectViewAssetResponseListPrevious
  results: ProjectViewAssetResponse[]
}
