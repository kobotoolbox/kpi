 ...
 */
import type { CreateFilePayloadOneOfTwoMetadata } from './createFilePayloadOneOfTwoMetadata'

export type CreateFilePayloadOneOfTwo = {
  user: string
  asset: string
  description: string
  file_type: string
  base64Encoded: string
  metadata: CreateFilePayloadOneOfTwoMetadata
}
