...
import type { SubscriptionApplicationFeePercent } from './subscriptionApplicationFeePercent'
import type { SubscriptionBillingCycleAnchor } from './subscriptionBillingCycleAnchor'
import type { SubscriptionBillingThresholds } from './subscriptionBillingThresholds'
import type { SubscriptionCancelAt } from './subscriptionCancelAt'
import type { SubscriptionCanceledAt } from './subscriptionCanceledAt'
import type { SubscriptionCreated } from './subscriptionCreated'
import type { SubscriptionDaysUntilDue } from './subscriptionDaysUntilDue'
import type { SubscriptionDefaultPaymentMethod } from './subscriptionDefaultPaymentMethod'
import type { SubscriptionDefaultSource } from './subscriptionDefaultSource'
import type { SubscriptionDescription } from './subscriptionDescription'
import type { SubscriptionDiscount } from './subscriptionDiscount'
import type { SubscriptionDjstripeOwnerAccount } from './subscriptionDjstripeOwnerAccount'
import type { SubscriptionEndedAt } from './subscriptionEndedAt'
/**
...
import type { SubscriptionLivemode } from './subscriptionLivemode'
import type { SubscriptionMetadata } from './subscriptionMetadata'
import type { SubscriptionNextPendingInvoiceItemInvoice } from './subscriptionNextPendingInvoiceItemInvoice'
...
import type { SubscriptionPendingSetupIntent } from './subscriptionPendingSetupIntent'
...
import type { SubscriptionProrationDate } from './subscriptionProrationDate'
import type { SubscriptionQuantity } from './subscriptionQuantity'
import type { SubscriptionSchedule } from './subscriptionSchedule'
import type { SubscriptionStartDate } from './subscriptionStartDate'
import type { SubscriptionStatusEnum } from './subscriptionStatusEnum'
import type { SubscriptionTrialEnd } from './subscriptionTrialEnd'
import type { SubscriptionTrialStart } from './subscriptionTrialStart'
...
* `send_invoice` - Send invoice */
   ...
   * @maximum 2147483647
   */
  days_until_due?: SubscriptionDaysUntilDue
  ...
  next_pending_invoice_item_invoice?: SubscriptionNextPendingInvoiceItemInvoice
...
* `none` - None */
  ...
  proration_date?: SubscriptionProrationDate
  /**
...
* `unpaid` - Unpaid */
  ...
  djstripe_owner_account?: SubscriptionDjstripeOwnerAccount
  ...
  default_source?: SubscriptionDefaultSource
  /** The most recent invoice this subscription has generated. */
  latest_invoice?: SubscriptionLatestInvoice
  ...
  pending_setup_intent?: SubscriptionPendingSetupIntent
