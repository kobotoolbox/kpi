 ...
 */
import type { _DataSupplementResponseQuestionNameXpathAutomatedGoogleTranscriptionVersionsItemData } from './_dataSupplementResponseQuestionNameXpathAutomatedGoogleTranscriptionVersionsItemData'

export type _DataSupplementResponseQuestionNameXpathAutomatedGoogleTranscriptionVersionsItem = {
  _dateCreated: string
  _uuid: string
  _dateAccepted?: string
  _data: _DataSupplementResponseQuestionNameXpathAutomatedGoogleTranscriptionVersionsItemData
}
