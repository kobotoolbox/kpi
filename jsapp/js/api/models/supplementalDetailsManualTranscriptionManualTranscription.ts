 ...
 */
import type { _SupplementalDetailsManualTranscriptionManualTranscriptionVersionsItem } from './_supplementalDetailsManualTranscriptionManualTranscriptionVersionsItem'

export type SupplementalDetailsManualTranscriptionManualTranscription = {
  _dateCreated: string
  _dateModified: string
  /** @minLength 1 */
  _versions: _SupplementalDetailsManualTranscriptionManualTranscriptionVersionsItem[]
}
