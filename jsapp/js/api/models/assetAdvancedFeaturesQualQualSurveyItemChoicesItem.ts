...
import type { AssetAdvancedFeaturesQualQualSurveyItemChoicesItemOptions } from './assetAdvancedFeaturesQualQualSurveyItemChoicesItemOptions'

export type AssetAdvancedFeaturesQualQualSurveyItemChoicesItem = {
  labels: AssetAdvancedFeaturesQualQualSurveyItemChoicesItemLabels
  uuid: string
  options?: AssetAdvancedFeaturesQualQualSurveyItemChoicesItemOptions
}
