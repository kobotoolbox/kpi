import type { SupplementalDataDependency } from './supplementalDataDependency'
/**
 ...
 */
import type { SupplementalDataQualDataAutomatic } from './supplementalDataQualDataAutomatic'

export interface SupplementalDataVersionItemQualAutomatic {
  _data: SupplementalDataQualDataAutomatic
  _dateAccepted?: string
  _dateCreated: string
  _dateVerified?: string
  _uuid: string
