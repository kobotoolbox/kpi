 ...
 */
import type { SupplementalDataVersionItemQualAutomatic } from './supplementalDataVersionItemQualAutomatic'

export interface SupplementalDataAutomaticQualItem {
  _dateCreated: string
  _dateModified: string
  /** @minLength 1 */
  _versions: SupplementalDataVersionItemQualAutomatic[]
}
