 ...
 */
import type { AuditLogResponseMetadataBulkActionParams } from './auditLogResponseMetadataBulkActionParams'

export type AuditLogResponseMetadataBulkAction = {
  uid?: string
  action_id?: string
  type?: string
  status?: string
  question_xpath?: string
  params?: AuditLogResponseMetadataBulkActionParams
  created_by?: string
  cancelled_by?: string
  total_count?: number
