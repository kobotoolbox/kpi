 ...
 */
import type { PaginatedUserReportsListResponseListNext } from './paginatedUserReportsListResponseListNext'
import type { PaginatedUserReportsListResponseListPrevious } from './paginatedUserReportsListResponseListPrevious'
import type { UserReportsListResponse } from './userReportsListResponse'

export interface PaginatedUserReportsListResponseList {
  /** @nullable */
  next?: PaginatedUserReportsListResponseListNext
  /** @nullable */
  previous?: PaginatedUserReportsListResponseListPrevious
  results: UserReportsListResponse[]
}
