 ...
 */
import type { PaginatedAccessLogResponseListNext } from './paginatedAccessLogResponseListNext'
import type { PaginatedAccessLogResponseListPrevious } from './paginatedAccessLogResponseListPrevious'

export interface PaginatedAccessLogResponseList {
  count: number
  /** @nullable */
  next?: PaginatedAccessLogResponseListNext
  /** @nullable */
  previous?: PaginatedAccessLogResponseListPrevious
  results: AccessLogResponse[]
}
