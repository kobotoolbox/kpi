 ...
 */
import type { AssetAttachmentAudioDurationItemSeconds } from './assetAttachmentAudioDurationItemSeconds'

export interface AssetAttachmentAudioDurationItem {
  uid: string
  seconds: AssetAttachmentAudioDurationItemSeconds
}
