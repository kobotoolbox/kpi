 ...
 * `resent` - Resent
 */
export type MemberListResponseInviteStatus =
  (typeof MemberListResponseInviteStatus)[keyof typeof MemberListResponseInviteStatus]

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const MemberListResponseInviteStatus = {
  accepted: 'accepted',
  cancelled: 'cancelled',
  declined: 'declined',
  expired: 'expired',
