 ...
 */
import type { _SupplementalDetailsAutomaticTranslationAutomaticGoogleTranslationVersionsItem } from './_supplementalDetailsAutomaticTranslationAutomaticGoogleTranslationVersionsItem'

/**
 * Map of language codes to automatic translation objects
 */
export type SupplementalDetailsAutomaticTranslationAutomaticGoogleTranslation = {
  [key: string]: {
    _dateCreated: string
    _dateModified: string
    /** @minLength 1 */
    _versions: _SupplementalDetailsAutomaticTranslationAutomaticGoogleTranslationVersionsItem[]
  }
}
