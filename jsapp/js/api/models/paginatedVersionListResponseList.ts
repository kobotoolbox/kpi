 ...
 */
import type { PaginatedVersionListResponseListNext } from './paginatedVersionListResponseListNext'
import type { PaginatedVersionListResponseListPrevious } from './paginatedVersionListResponseListPrevious'
import type { VersionListResponse } from './versionListResponse'

export interface PaginatedVersionListResponseList {
  count: number
  /** @nullable */
  next?: PaginatedVersionListResponseListNext
  /** @nullable */
  previous?: PaginatedVersionListResponseListPrevious
  results: VersionListResponse[]
}
