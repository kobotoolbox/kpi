 ...
 */
import type { _SupplementalDetailsManualQualManualQualVersionsItem } from './_supplementalDetailsManualQualManualQualVersionsItem'

/**
 * Map of qual question UUIDs to qual response objects
 */
export type SupplementalDetailsManualQualManualQual = {
  [key: string]: {
    _dateCreated: string
    _dateModified: string
    /** @minLength 1 */
    _versions: _SupplementalDetailsManualQualManualQualVersionsItem[]
  }
}
