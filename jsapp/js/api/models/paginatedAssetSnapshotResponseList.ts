 ...
 */
import type { PaginatedAssetSnapshotResponseListNext } from './paginatedAssetSnapshotResponseListNext'
import type { PaginatedAssetSnapshotResponseListPrevious } from './paginatedAssetSnapshotResponseListPrevious'

export interface PaginatedAssetSnapshotResponseList {
  count: number
  /** @nullable */
  next?: PaginatedAssetSnapshotResponseListNext
  /** @nullable */
  previous?: PaginatedAssetSnapshotResponseListPrevious
