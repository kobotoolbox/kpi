import type { _DataSupplementResponseQuestionNameXpathManualTranslationVersionsItemData } from './_dataSupplementResponseQuestionNameXpathManualTranslationVersionsItemData'
/**
 ...
 */
import type { _DataSupplementResponseQuestionNameXpathManualTranslationVersionsItemDependency } from './_dataSupplementResponseQuestionNameXpathManualTranslationVersionsItemDependency'

export type _DataSupplementResponseQuestionNameXpathManualTranslationVersionsItem = {
  _dateCreated: string
  _uuid: string
  _dependency: _DataSupplementResponseQuestionNameXpathManualTranslationVersionsItemDependency
  _dateAccepted: string
  _data: _DataSupplementResponseQuestionNameXpathManualTranslationVersionsItemData
}
