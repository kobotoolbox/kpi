 ...
 */
import type { SupplementalDataActionObjectAutomaticWithDep } from './supplementalDataActionObjectAutomaticWithDep'

/**
 * Map of language codes to automatic translation objects
 */
export interface SupplementalDataTranslationMapAutomatic {
  [key: string]: SupplementalDataActionObjectAutomaticWithDep
}
