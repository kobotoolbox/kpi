 ...
 */
import type { _DataSupplementResponseQuestionNameXpathManualTranscriptionVersionsItemData } from './_dataSupplementResponseQuestionNameXpathManualTranscriptionVersionsItemData'

export type _DataSupplementResponseQuestionNameXpathManualTranscriptionVersionsItem = {
  _dateCreated: string
  _uuid: string
  _dateAccepted: string
  _data: _DataSupplementResponseQuestionNameXpathManualTranscriptionVersionsItemData
}
