 ...
 */
import type { PaginatedTranslationServiceListNext } from './paginatedTranslationServiceListNext'
import type { PaginatedTranslationServiceListPrevious } from './paginatedTranslationServiceListPrevious'
import type { TranslationService } from './translationService'

export interface PaginatedTranslationServiceList {
  count: number
  /** @nullable */
  next?: PaginatedTranslationServiceListNext
  /** @nullable */
  previous?: PaginatedTranslationServiceListPrevious
