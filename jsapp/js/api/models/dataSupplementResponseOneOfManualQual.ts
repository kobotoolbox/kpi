 ...
 */
import type { _DataSupplementResponseOneOfManualQualVersionsItem } from './_dataSupplementResponseOneOfManualQualVersionsItem'

export type DataSupplementResponseOneOfManualQual = {
  [key: string]: {
    _dateCreated: string
    _dateModified: string
    /** @minLength 1 */
    _versions: _DataSupplementResponseOneOfManualQualVersionsItem[]
  }
}
