 ...
 */
import type { SupplementalDataVersionItemAutomatic } from './supplementalDataVersionItemAutomatic'

export interface SupplementalDataAutomaticTranscription {
  _dateCreated: string
  _dateModified: string
  /** @minLength 1 */
  _versions: SupplementalDataVersionItemAutomatic[]
}
