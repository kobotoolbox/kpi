 ...
 */
import type { AssetCreateRequestOneOfTwoSettings } from './assetCreateRequestOneOfTwoSettings'

export type AssetCreateRequestOneOfTwo = {
  name: string
  settings: AssetCreateRequestOneOfTwoSettings
  asset_type: string
}
