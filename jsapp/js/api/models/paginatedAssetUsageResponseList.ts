import type { AssetUsageResponse } from './assetUsageResponse'
/**
 ...
 */
import type { PaginatedAssetUsageResponseListNext } from './paginatedAssetUsageResponseListNext'
import type { PaginatedAssetUsageResponseListPrevious } from './paginatedAssetUsageResponseListPrevious'

export interface PaginatedAssetUsageResponseList {
  count: number
  /** @nullable */
  next?: PaginatedAssetUsageResponseListNext
  /** @nullable */
  previous?: PaginatedAssetUsageResponseListPrevious
  results: AssetUsageResponse[]
}
