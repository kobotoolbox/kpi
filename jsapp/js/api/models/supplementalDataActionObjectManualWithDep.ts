 ...
 */
import type { SupplementalDataVersionItemManualWithDep } from './supplementalDataVersionItemManualWithDep'

export interface SupplementalDataActionObjectManualWithDep {
  _dateCreated: string
  _dateModified: string
  /** @minLength 1 */
  _versions: SupplementalDataVersionItemManualWithDep[]
}
