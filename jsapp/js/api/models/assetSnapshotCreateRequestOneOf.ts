 ...
 */
import type { AssetSnapshotCreateRequestOneOfDetails } from './assetSnapshotCreateRequestOneOfDetails'

export type AssetSnapshotCreateRequestOneOf = {
  asset: string
  details: AssetSnapshotCreateRequestOneOfDetails
}
