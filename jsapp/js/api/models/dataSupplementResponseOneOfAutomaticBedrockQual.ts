 ...
 */
import type { _DataSupplementResponseOneOfAutomaticBedrockQualVersionsItem } from './_dataSupplementResponseOneOfAutomaticBedrockQualVersionsItem'

export type DataSupplementResponseOneOfAutomaticBedrockQual = {
  [key: string]: {
    _dateCreated: string
    _dateModified: string
    /** @minLength 1 */
    _versions: _DataSupplementResponseOneOfAutomaticBedrockQualVersionsItem[]
  }
}
