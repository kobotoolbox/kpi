 ...
 */
import type { _SupplementalDetailsAutomaticTranscriptionAutomaticGoogleTranscriptionVersionsItemData } from './_supplementalDetailsAutomaticTranscriptionAutomaticGoogleTranscriptionVersionsItemData'

export type _SupplementalDetailsAutomaticTranscriptionAutomaticGoogleTranscriptionVersionsItem = {
  _dateCreated: string
  _uuid: string
  _dateAccepted?: string
  _data: _SupplementalDetailsAutomaticTranscriptionAutomaticGoogleTranscriptionVersionsItemData
}
