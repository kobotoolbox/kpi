 ...
 */
import type { AssetBulkRequestOneOfAssetUids } from './assetBulkRequestOneOfAssetUids'

export type AssetBulkRequestOneOf = {
  asset_uids: AssetBulkRequestOneOfAssetUids
  action: string
}
