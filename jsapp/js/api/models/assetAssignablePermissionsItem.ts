 ...
 */
import type { AssetAssignablePermissionsItemLabel } from './assetAssignablePermissionsItemLabel'

export type AssetAssignablePermissionsItem = {
  url: string
  label: AssetAssignablePermissionsItemLabel
}
