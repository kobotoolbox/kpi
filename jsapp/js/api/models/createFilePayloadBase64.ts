 ...
 */
import type { CreateFilePayloadBase64Metadata } from './createFilePayloadBase64Metadata'

export interface CreateFilePayloadBase64 {
  description: string
  file_type: string
  base64Encoded: string
  metadata: CreateFilePayloadBase64Metadata
}
