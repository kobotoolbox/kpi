 ...
 */
import type { _SupplementalDetailsManualTranscriptionManualTranscriptionVersionsItemData } from './_supplementalDetailsManualTranscriptionManualTranscriptionVersionsItemData'

export type _SupplementalDetailsManualTranscriptionManualTranscriptionVersionsItem = {
  _dateCreated: string
  _uuid: string
  _dateAccepted: string
  _data: _SupplementalDetailsManualTranscriptionManualTranscriptionVersionsItemData
}
