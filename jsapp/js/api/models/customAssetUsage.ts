import type { CustomAssetUsageDeploymentStatusEnum } from './customAssetUsageDeploymentStatusEnum'
/**
...
export interface CustomAssetUsage {
  ...
  readonly deployment_status: CustomAssetUsageDeploymentStatusEnum
}
