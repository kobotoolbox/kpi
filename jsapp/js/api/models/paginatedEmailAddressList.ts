 ...
 */
import type { PaginatedEmailAddressListNext } from './paginatedEmailAddressListNext'
import type { PaginatedEmailAddressListPrevious } from './paginatedEmailAddressListPrevious'

export interface PaginatedEmailAddressList {
  count: number
  /** @nullable */
  next?: PaginatedEmailAddressListNext
  /** @nullable */
  previous?: PaginatedEmailAddressListPrevious
