 ...
 */
import type { AssetBulkRequestWithUidsAssetUids } from './assetBulkRequestWithUidsAssetUids'

export interface AssetBulkRequestWithUids {
  asset_uids: AssetBulkRequestWithUidsAssetUids
  action: string
}
