 ...
 */
import type { PaginatedUserListResponseListNext } from './paginatedUserListResponseListNext'
import type { PaginatedUserListResponseListPrevious } from './paginatedUserListResponseListPrevious'
import type { UserListResponse } from './userListResponse'

export interface PaginatedUserListResponseList {
  count: number
  /** @nullable */
  next?: PaginatedUserListResponseListNext
  /** @nullable */
  previous?: PaginatedUserListResponseListPrevious
