 ...
 */
import type { ExportSettingCreatePayloadExportSettings } from './exportSettingCreatePayloadExportSettings'

export interface ExportSettingCreatePayload {
  name: string
  export_settings: ExportSettingCreatePayloadExportSettings
}
