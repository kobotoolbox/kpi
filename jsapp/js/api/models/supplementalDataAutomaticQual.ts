 ...
 */
import type { SupplementalDataAutomaticQualItem } from './supplementalDataAutomaticQualItem'

/**
 * Map of automatic question UUIDs to their action objects
 */
export interface SupplementalDataAutomaticQual {
  [key: string]: SupplementalDataAutomaticQualItem
}
