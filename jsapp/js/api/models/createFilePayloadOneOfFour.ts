 ...
 */
import type { CreateFilePayloadOneOfFourMetadata } from './createFilePayloadOneOfFourMetadata'

export type CreateFilePayloadOneOfFour = {
  user: string
  asset: string
  description: string
  file_type: string
  metadata: CreateFilePayloadOneOfFourMetadata
}
