 ...
 */
import type { _DataSupplementResponseOneOfOneOfQualVersionsItem } from './_dataSupplementResponseOneOfOneOfQualVersionsItem'

export type DataSupplementResponseOneOfOneOfQual = {
  [key: string]: {
    _dateCreated: string
    _dateModified: string
    /** @minLength 1 */
    _versions: _DataSupplementResponseOneOfOneOfQualVersionsItem[]
  }
}
