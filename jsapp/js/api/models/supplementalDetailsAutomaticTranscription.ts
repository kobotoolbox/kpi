 ...
 */
import type { SupplementalDetailsAutomaticTranscriptionAutomaticGoogleTranscription } from './supplementalDetailsAutomaticTranscriptionAutomaticGoogleTranscription'

/**
 * Automatic Google transcription supplemental details
 */
export interface SupplementalDetailsAutomaticTranscription {
  [key: string]: {
    automatic_google_transcription: SupplementalDetailsAutomaticTranscriptionAutomaticGoogleTranscription
  }
}
