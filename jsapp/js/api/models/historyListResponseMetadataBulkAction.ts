 ...
 */
import type { HistoryListResponseMetadataBulkActionParams } from './historyListResponseMetadataBulkActionParams'

export type HistoryListResponseMetadataBulkAction = {
  uid?: string
  action_id?: string
  type?: string
  status?: string
  question_xpath?: string
  params?: HistoryListResponseMetadataBulkActionParams
  created_by?: string
  cancelled_by?: string
  total_count?: number
