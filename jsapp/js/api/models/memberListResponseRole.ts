 ...
 * @nullable
 */
export type MemberListResponseRole = typeof MemberListResponseRole[keyof typeof MemberListResponseRole]  | null;
slint-disable-next-line @typescript-eslint/no-redeclare
export const MemberListResponseRole = {...MemberRoleEnum,...BlankEnum,...NullEnum,} as const