 ...
 */
import type { _SupplementalDetailsAutomaticTranscriptionAutomaticGoogleTranscriptionVersionsItem } from './_supplementalDetailsAutomaticTranscriptionAutomaticGoogleTranscriptionVersionsItem'

export type SupplementalDetailsAutomaticTranscriptionAutomaticGoogleTranscription = {
  _dateCreated: string
  _dateModified: string
  /** @minLength 1 */
  _versions: _SupplementalDetailsAutomaticTranscriptionAutomaticGoogleTranscriptionVersionsItem[]
}
