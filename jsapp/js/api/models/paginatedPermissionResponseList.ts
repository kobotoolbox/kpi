 ...
 */
import type { PaginatedPermissionResponseListNext } from './paginatedPermissionResponseListNext'
import type { PaginatedPermissionResponseListPrevious } from './paginatedPermissionResponseListPrevious'
import type { PermissionResponse } from './permissionResponse'

export interface PaginatedPermissionResponseList {
  count: number
  /** @nullable */
  next?: PaginatedPermissionResponseListNext
  /** @nullable */
  previous?: PaginatedPermissionResponseListPrevious
