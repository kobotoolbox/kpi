 ...
 */
import type { _DataSupplementResponseOneOfOneOfManualTranscriptionVersionsItem } from './_dataSupplementResponseOneOfOneOfManualTranscriptionVersionsItem'

export type DataSupplementResponseOneOfOneOfManualTranscription = {
  _dateCreated: string
  _dateModified: string
  /** @minLength 1 */
  _versions: _DataSupplementResponseOneOfOneOfManualTranscriptionVersionsItem[]
}
