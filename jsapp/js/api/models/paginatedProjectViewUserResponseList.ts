 ...
 */
import type { PaginatedProjectViewUserResponseListNext } from './paginatedProjectViewUserResponseListNext'
import type { PaginatedProjectViewUserResponseListPrevious } from './paginatedProjectViewUserResponseListPrevious'
import type { ProjectViewUserResponse } from './projectViewUserResponse'

export interface PaginatedProjectViewUserResponseList {
  count: number
  /** @nullable */
  next?: PaginatedProjectViewUserResponseListNext
  /** @nullable */
  previous?: PaginatedProjectViewUserResponseListPrevious
  results: ProjectViewUserResponse[]
}
