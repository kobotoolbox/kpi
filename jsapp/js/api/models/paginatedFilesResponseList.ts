 ...
 */
import type { PaginatedFilesResponseListNext } from './paginatedFilesResponseListNext'
import type { PaginatedFilesResponseListPrevious } from './paginatedFilesResponseListPrevious'

export interface PaginatedFilesResponseList {
  count: number
  /** @nullable */
  next?: PaginatedFilesResponseListNext
  /** @nullable */
  previous?: PaginatedFilesResponseListPrevious
