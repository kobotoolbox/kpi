 ...
 */
import type { _DataSupplementResponseOneOfManualTranscriptionVersionsItemData } from './_dataSupplementResponseOneOfManualTranscriptionVersionsItemData'

export type _DataSupplementResponseOneOfManualTranscriptionVersionsItem = {
  _dateCreated: string
  _uuid: string
  _dateAccepted: string
  _data: _DataSupplementResponseOneOfManualTranscriptionVersionsItemData
}
