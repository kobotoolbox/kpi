 ...
 */
import type { PaginatedImportResponseListNext } from './paginatedImportResponseListNext'
import type { PaginatedImportResponseListPrevious } from './paginatedImportResponseListPrevious'

export interface PaginatedImportResponseList {
  count: number
  /** @nullable */
  next?: PaginatedImportResponseListNext
  /** @nullable */
  previous?: PaginatedImportResponseListPrevious
