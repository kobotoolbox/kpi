 ...
 */
import type { PaginatedInviteResponseListNext } from './paginatedInviteResponseListNext'
import type { PaginatedInviteResponseListPrevious } from './paginatedInviteResponseListPrevious'

export interface PaginatedInviteResponseList {
  count: number
  /** @nullable */
  next?: PaginatedInviteResponseListNext
  /** @nullable */
  previous?: PaginatedInviteResponseListPrevious
