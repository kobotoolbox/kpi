 ...
 */
import type { PaginatedOrganizationResponseListNext } from './paginatedOrganizationResponseListNext'
import type { PaginatedOrganizationResponseListPrevious } from './paginatedOrganizationResponseListPrevious'

export interface PaginatedOrganizationResponseList {
  count: number
  /** @nullable */
  next?: PaginatedOrganizationResponseListNext
  /** @nullable */
  previous?: PaginatedOrganizationResponseListPrevious
