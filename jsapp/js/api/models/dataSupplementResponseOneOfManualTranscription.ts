 ...
 */
import type { _DataSupplementResponseOneOfManualTranscriptionVersionsItem } from './_dataSupplementResponseOneOfManualTranscriptionVersionsItem'

export type DataSupplementResponseOneOfManualTranscription = {
  _dateCreated: string
  _dateModified: string
  /** @minLength 1 */
  _versions: _DataSupplementResponseOneOfManualTranscriptionVersionsItem[]
}
