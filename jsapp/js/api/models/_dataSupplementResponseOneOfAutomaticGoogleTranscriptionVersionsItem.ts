 ...
 */
import type { _DataSupplementResponseOneOfAutomaticGoogleTranscriptionVersionsItemData } from './_dataSupplementResponseOneOfAutomaticGoogleTranscriptionVersionsItemData'

export type _DataSupplementResponseOneOfAutomaticGoogleTranscriptionVersionsItem = {
  _dateCreated: string
  _uuid: string
  _dateAccepted?: string
  _data: _DataSupplementResponseOneOfAutomaticGoogleTranscriptionVersionsItemData
}
