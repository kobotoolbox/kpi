 ...
 */
import type { PaginatedPairedDataResponseListNext } from './paginatedPairedDataResponseListNext'
import type { PaginatedPairedDataResponseListPrevious } from './paginatedPairedDataResponseListPrevious'
import type { PairedDataResponse } from './pairedDataResponse'

export interface PaginatedPairedDataResponseList {
  count: number
  /** @nullable */
  next?: PaginatedPairedDataResponseListNext
  /** @nullable */
  previous?: PaginatedPairedDataResponseListPrevious
  results: PairedDataResponse[]
}
