 ...
 */
import type { PaginatedDataResponseListNext } from './paginatedDataResponseListNext'
import type { PaginatedDataResponseListPrevious } from './paginatedDataResponseListPrevious'

export interface PaginatedDataResponseList {
  count: number
  /** @nullable */
  next?: PaginatedDataResponseListNext
  /** @nullable */
  previous?: PaginatedDataResponseListPrevious
