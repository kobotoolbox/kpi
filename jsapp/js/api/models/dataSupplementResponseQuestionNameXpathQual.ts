 ...
 */
import type { _DataSupplementResponseQuestionNameXpathQualVersionsItem } from './_dataSupplementResponseQuestionNameXpathQualVersionsItem'

export type DataSupplementResponseQuestionNameXpathQual = {
  [key: string]: {
    _dateCreated: string
    _dateModified: string
    /** @minLength 1 */
    _versions: _DataSupplementResponseQuestionNameXpathQualVersionsItem[]
  }
}
