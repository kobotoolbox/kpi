 ...
 */
import type { ProjectHistoryLogResponseMetadataBulkActionParams } from './projectHistoryLogResponseMetadataBulkActionParams'

export type ProjectHistoryLogResponseMetadataBulkAction = {
  uid?: string
  action_id?: string
  type?: string
  status?: string
  question_xpath?: string
  params?: ProjectHistoryLogResponseMetadataBulkActionParams
  created_by?: string
  cancelled_by?: string
  total_count?: number
