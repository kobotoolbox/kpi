...
import type { CreateResponseQualSelectQuestionParamsChoicesItem } from './createResponseQualSelectQuestionParamsChoicesItem'
import type { CreateResponseQualSelectQuestionParamsHint } from './createResponseQualSelectQuestionParamsHint'
import type { CreateResponseQualSelectQuestionParamsLabels } from './createResponseQualSelectQuestionParamsLabels'
import type { QualSelectQuestionParamsTypeEnum } from './qualSelectQuestionParamsTypeEnum'

export interface CreateResponseQualSelectQuestionParams {
  uuid: string
  type: QualSelectQuestionParamsTypeEnum
  labels: CreateResponseQualSelectQuestionParamsLabels
  choices: CreateResponseQualSelectQuestionParamsChoicesItem[]
  hint?: CreateResponseQualSelectQuestionParamsHint
}
