...
import type {AssetResponse, AssetDownloads, ProjectViewAsset} from 'js/dataInterface';
import {
...
import './projectsActionButtons.module.scss';
import type {WithRouterProps} from 'jsapp/js/router/legacy';
import {withRouter} from 'jsapp/js/router/legacy';

bem.ProjectsActionButtons = makeBem(null, 'project-action-buttons', 'menu');
bem.ProjectsActionButtons__button = makeBem(bem.ProjectsActionButtons, 'button', 'a');
bem.ProjectsActionButtons__iconButton = makeBem(bem.ProjectsActionButtons, 'icon-button', 'a');

const assetActions = mixins.clickAssets.click.asset;

interface ProjectsActionButtonsProps extends WithRouterProps {
  asset: AssetResponse | ProjectViewAsset;
  has_deployment?: boolean;
  deployment__active?: boolean;
}

interface ProjectsActionButtonsState {
...
class ProjectsActionButtons extends React.Component<
  ProjectsActionButtonsProps,
  ProjectsActionButtonsState
> {
  ...
  constructor(props: ProjectsActionButtonsProps) {
    super(props);
    this.state = {
  ...
  viewContainingCollection() {
    if (!('parent' in this.props.asset) || this.props.asset.parent === null) {
      return;
    }
  ...
  renderSubButton() {
    ...
    if (
      ...
      return (
        <bem.ProjectsActionButtons__button
          m={modifiers}
          onClick={fn}
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {userCanEdit && assetType !== ASSET_TYPES.collection.id &&
          <bem.ProjectsActionButtons__iconButton
...
export default withRouter(ProjectsActionButtons);
