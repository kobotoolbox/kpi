...
KOBO_SUPPORT_URL = os.environ.get('KOBO_SUPPORT_URL', 'http://asimov.cl/')
KOBO_SUPPORT_EMAIL = os.environ.get('KOBO_SUPPORT_EMAIL') or os.environ.get('DEFAULT_FROM_EMAIL', 'dev@asimov.cl')
