...
EXAMPLES = [{'labels': {'_default': 'Any descriptors?'},
  'qpath': '<QPATH>',
 ...
 {'labels': {'_default': 'How many people are heard speaking in this '
                         'response?'},
  'qpath': '<QPATH>',
  'scope': 'by_question#survey',
  'type': 'qual_integer',
  'uuid': '22222222-2222-2222-2222-222222222222'},
 {'choices': [{'labels': {'_default': 'Yes'},
               'uuid': '44444444-4444-4444-4444-444444444444'},
              {'labels': {'_default': 'No'},
               'uuid': '55555555-5555-5555-5555-555555555555'}],
  'labels': {'_default': 'Do they describe the facility as being well '
                         'maintained?'},
  'qpath': '<QPATH>',
  'scope': 'by_question#survey',
  'type': 'qual_select_one',
  'uuid': '33333333-3333-3333-3333-333333333333'},
 {'choices': [{'labels': {'_default': 'Lighting'},
 ...
 {'labels': {'_default': 'Please respect the confidentiality of our '
                         'respondents.'},
  'qpath': '<QPATH>',
  'scope': 'by_question#survey',
  'type': 'qual_note',
...
def run():
    ...
    if asset.submission_extras.count() == 0:
        print('If a submission_extras model exists, this script will populate '
              'it with sample data')
        # asset.submission_extras.create(submission_uuid='...')
    else:
