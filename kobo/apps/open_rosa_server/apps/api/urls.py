...
from kobo.apps.open_rosa_server.apps.api.viewsets.attachment_viewset import AttachmentViewSet
from kobo.apps.open_rosa_server.apps.api.viewsets.briefcase_api import BriefcaseApi
from kobo.apps.open_rosa_server.apps.api.viewsets.connect_viewset import ConnectViewSet
from kobo.apps.open_rosa_server.apps.api.viewsets.data_viewset import DataViewSet
from kobo.apps.open_rosa_server.apps.api.viewsets.metadata_viewset import MetaDataViewSet
from kobo.apps.open_rosa_server.apps.api.viewsets.note_viewset import NoteViewSet
from kobo.apps.open_rosa_server.apps.api.viewsets.user import UserViewSet
from kobo.apps.open_rosa_server.apps.api.viewsets.xform_list_api import XFormListApi
from kobo.apps.open_rosa_server.apps.api.viewsets.xform_submission_api import XFormSubmissionApi
from kobo.apps.open_rosa_server.apps.api.viewsets.xform_viewset import XFormViewSet
