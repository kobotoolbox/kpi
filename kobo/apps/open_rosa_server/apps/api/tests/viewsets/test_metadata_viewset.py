...
from kobo.apps.open_rosa_server.apps.api.tests.viewsets.test_abstract_viewset import (
    TestAbstractViewSet)
...
from kobo.apps.open_rosa_server.libs.constants import CAN_CHANGE_XFORM, CAN_VIEW_XFORM
