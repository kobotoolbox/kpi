...
from kobo.apps.open_rosa_server.apps.main import tests as main_tests
from kobo.apps.open_rosa_server.apps.main.models import UserProfile, MetaData
from kobo.apps.open_rosa_server.libs.tests.mixins.make_submission_mixin import MakeSubmissionMixin
from kobo.apps.open_rosa_server.libs.tests.mixins.request_mixin import RequestMixin
