...
from kobo.apps.open_rosa_server.apps.main.forms import QuickConverterForm
...
from kobo.apps.open_rosa_server.apps.viewer.models.parsed_instance import datetime_from_str
