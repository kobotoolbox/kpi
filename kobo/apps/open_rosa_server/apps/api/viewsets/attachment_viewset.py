...
from kobo.apps.open_rosa_server.apps.api.permissions import AttachmentObjectPermissions
...
from kobo.apps.open_rosa_server.libs.serializers.attachment_serializer import AttachmentSerializer
