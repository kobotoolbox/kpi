...
from kobo.apps.open_rosa_server.apps.api import tools as utils
from kobo.apps.open_rosa_server.apps.api.permissions import XFormPermissions
from kobo.apps.open_rosa_server.apps.logger.models.xform import XForm
from kobo.apps.open_rosa_server.apps.viewer.models.export import Export
from kobo.apps.open_rosa_server.libs import filters
from kobo.apps.open_rosa_server.libs.exceptions import NoRecordsFoundError
from kobo.apps.open_rosa_server.libs.mixins.anonymous_user_public_forms_mixin import (
    AnonymousUserPublicFormsMixin
)
from kobo.apps.open_rosa_server.libs.mixins.labels_mixin import LabelsMixin
from kobo.apps.open_rosa_server.libs.renderers import renderers
from kobo.apps.open_rosa_server.libs.serializers.xform_serializer import XFormSerializer
from kobo.apps.open_rosa_server.libs.utils import log
from kobo.apps.open_rosa_server.libs.utils.common_tags import SUBMISSION_TIME
from kobo.apps.open_rosa_server.libs.utils.csv_import import submit_csv
from kobo.apps.open_rosa_server.libs.utils.export_tools import (
    generate_export,
    should_create_new_export,
)
from kobo.apps.open_rosa_server.libs.utils.export_tools import newset_export_for
from kobo.apps.open_rosa_server.libs.utils.logger_tools import response_with_mimetype_and_name
from kobo.apps.open_rosa_server.libs.utils.storage import rmdir
from kobo.apps.open_rosa_server.libs.utils.string import str2bool
from kobo.apps.open_rosa_server.libs.utils.viewer_tools import format_date_for_mongo
...
"""
    ...
    def create(self, request, *args, **kwargs):
        ...
        if isinstance(survey, XForm):
            ...
            # `kobo.apps.open_rosa_server.apps.main.forms.QuickConverterForm`, which uses standard
    ...
    def update(self, request, pk, *args, **kwargs):
        if 'xls_file' in request.FILES:
            ...
            # Behave like `kobo.apps.open_rosa_server.apps.main.views.update_xform`: only allow
    ...
    def csv_import(self, request, *args, **kwargs):
        ...
        Calls :py:func:`kobo.apps.open_rosa_server.libs.utils.csv_import.submit_csv`
        ...
        if request.user != xform.user:
            ...
            # `kobo.apps.open_rosa_server.apps.logger.models.xform.set_object_permissions()`.
