...
from kobo.apps.open_rosa_server.apps.main.signals import set_api_permissions
from kobo.apps.open_rosa_server.libs.utils.country_field import COUNTRIES
from kobo.apps.open_rosa_server.libs.utils.gravatar import get_gravatar_img_link, gravatar_exists
