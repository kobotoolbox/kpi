...
from kobo.apps.open_rosa_server.apps.api.urls import BriefcaseApi
from kobo.apps.open_rosa_server.apps.api.urls import XFormListApi
from kobo.apps.open_rosa_server.apps.api.urls import XFormSubmissionApi
from kobo.apps.open_rosa_server.apps.api.urls import router, router_with_patch_list
from kobo.apps.open_rosa_server.apps.main.service_health import service_health

# exporting stuff
from kobo.apps.open_rosa_server.apps.viewer.views import (
    attachment_url,
    create_export,
    delete_export,
    export_progress,
...
from kobo.apps.open_rosa_server.apps.logger.views import (
    bulksubmission,
    bulksubmission_form,
    download_xlsform,
    download_jsonform,
...
urlpatterns = [
    ...
    re_path(r"^{}(?P<size>[^/]+)$".format(settings.MEDIA_URL.lstrip('/')),
            attachment_url, name='attachment_url'),
    re_path(r'^jsi18n/$', JavaScriptCatalog.as_view(packages=['kobo.apps.open_rosa_server.apps.main', 'kobo.apps.open_rosa_server.apps.viewer']),
