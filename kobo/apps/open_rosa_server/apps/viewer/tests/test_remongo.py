...
from kobo.apps.open_rosa_server.apps.viewer.management.commands.remongo import Command
from kobo.apps.open_rosa_server.libs.utils.common_tags import USERFORM_ID
