...
from kobo.apps.open_rosa_server.libs.utils.export_tools import question_types_to_exclude
...
class CSVDataFrameBuilder(AbstractDataFrameBuilder):
    ...
    def _reindex(cls, key, value, ordered_columns, parent_prefix=None):
        ...
        if type(value) is list and len(value) > 0 \
            ...
            if key == NOTES:
                # Match behavior of
                # kobo.apps.open_rosa_server.libs.utils.export_tools.dict_to_joined_export()
