...
from kobo.apps.open_rosa_server.apps.restservice.RestServiceInterface import RestServiceInterface
from kobo.apps.open_rosa_server.apps.restservice.models import RestService
