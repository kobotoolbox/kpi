...
from kobo.apps.open_rosa_server.apps.logger.models.attachment import upload_to as\
    attachment_upload_to
from kobo.apps.open_rosa_server.apps.logger.models.xform import XForm, upload_to as\
    xform_upload_to
