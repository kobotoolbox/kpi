...
import kobo.apps.open_rosa_server.apps.logger.models.attachment
import kobo.apps.open_rosa_server.apps.logger.models.xform
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media_file', models.FileField(upload_to=kobo.apps.open_rosa_server.apps.logger.models.attachment.upload_to)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('xls', models.FileField(null=True, upload_to=kobo.apps.open_rosa_server.apps.logger.models.xform.upload_to)),
