...
from kobo.apps.open_rosa_server.apps.logger.fields import LazyDefaultBooleanField
from kobo.apps.open_rosa_server.apps.logger.models.daily_xform_submission_counter import DailyXFormSubmissionCounter
from kobo.apps.open_rosa_server.apps.logger.models.monthly_xform_submission_counter import (
    MonthlyXFormSubmissionCounter,
)
from kobo.apps.open_rosa_server.apps.logger.xform_instance_parser import XLSFormError
from kobo.apps.open_rosa_server.koboform.pyxform_utils import convert_csv_to_xls
from kobo.apps.open_rosa_server.libs.constants import (
    CAN_ADD_SUBMISSIONS,
    CAN_VALIDATE_XFORM,
    CAN_DELETE_DATA_XFORM,
    CAN_TRANSFER_OWNERSHIP,
)
from kobo.apps.open_rosa_server.libs.utils.xml import XMLFormWithDisclaimer
from kobo.apps.open_rosa_server.libs.models.base_model import BaseModel
from kobo.apps.open_rosa_server.libs.utils.hash import get_hash
...
class XForm(BaseModel):
    ...
    def settings(self):
        ...
        # (kobocat/kobo.apps.open_rosa_server/apps/api/tools.py) should still work
