...
from kobo.apps.open_rosa_server.apps.logger.xform_instance_parser import XFormInstanceParser,\
    xpath_from_xml_node
from kobo.apps.open_rosa_server.apps.logger.xform_instance_parser import get_uuid_from_xml,\
    get_meta_from_xml, get_deprecated_uuid_from_xml,\
    _xml_node_to_dict, clean_and_parse_xml
from kobo.apps.open_rosa_server.libs.utils.common_tags import XFORM_ID_STRING
