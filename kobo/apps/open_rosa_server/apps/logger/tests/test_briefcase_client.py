...
from kobo.apps.open_rosa_server.apps.logger.models import Instance, XForm
...
from kobo.apps.open_rosa_server.libs.utils.briefcase_client import BriefcaseClient
