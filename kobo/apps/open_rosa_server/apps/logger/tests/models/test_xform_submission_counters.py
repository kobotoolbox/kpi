...
from kobo.apps.open_rosa_server.apps.logger.models.monthly_xform_submission_counter import MonthlyXFormSubmissionCounter
from kobo.apps.open_rosa_server.apps.logger.tasks import delete_daily_counters
