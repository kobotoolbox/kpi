...
# FIXME Merged
# MIDDLEWARE = [
#     # 'kobo.apps.open_rosa_server.koboform.redirect_middleware.ConditionalRedirects',
...
#     # 'kobo.apps.open_rosa_server.libs.utils.middleware.UsernameInResponseHeaderMiddleware',
# ]


# FIXME To be merged
# ROOT_URLCONF = 'kobo.apps.open_rosa_server.apps.main.urls'
...
#                 'kobo.apps.open_rosa_server.koboform.context_processors.koboform_integration',
#                 'kobo.apps.open_rosa_server.apps.main.context_processors.google_analytics',
#                 'kobo.apps.open_rosa_server.apps.main.context_processors.site_name',
#                 'kobo.apps.open_rosa_server.apps.main.context_processors.base_url'
#             ],
#             'loaders': [
...
LOGGING = {
    ...
    'handlers': {
        ...
        'audit': {
            'level': 'DEBUG',
            'class': 'kobo.apps.open_rosa_server.libs.utils.log.AuditLogHandler',
            'formatter': 'verbose',
            'model': 'kobo.apps.open_rosa_server.apps.main.models.audit.AuditLog'
        }
    },
    'loggers': {
        'django.request': {
...
# AUTH_PROFILE_MODULE = 'kobo.apps.open_rosa_server.apps.main.UserProfile'
...
#         DEFAULT_FILE_STORAGE = 'kobo.apps.open_rosa_server.apps.storage_backends.s3boto3.S3Boto3Storage'
...
DIGEST_NONCE_BACKEND = 'kobo.apps.open_rosa_server.apps.django_digest_backends.cache.RedisCacheNonceStorage'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'kobo.apps.open_rosa_server.libs.authentication.DigestAuthentication',
        'oauth2_provider.contrib.rest_framework.OAuth2Authentication',
        'kobo.apps.open_rosa_server.libs.authentication.TokenAuthentication',
        ...
        'kobo.apps.open_rosa_server.libs.authentication.HttpsOnlyBasicAuthentication',
    ...
    'VIEW_NAME_FUNCTION': 'kobo.apps.open_rosa_server.apps.api.tools.get_view_name',
    'VIEW_DESCRIPTION_FUNCTION': 'kobo.apps.open_rosa_server.apps.api.tools.get_view_description',
}
...
GUARDIAN_GET_INIT_ANONYMOUS_USER = 'kobo.apps.open_rosa_server.apps.main.models.user_profile.get_anonymous_user_instance'  # noqa
...
CELERY_BEAT_SCHEDULE = {
    ...
    'log-stuck-exports-and-mark-failed': {
        'task': 'kobo.apps.open_rosa_server.apps.viewer.tasks.log_stuck_exports_and_mark_failed',
        'schedule': timedelta(hours=6),
        'options': {'queue': 'kobocat_queue'}
    },
    'delete-daily-xform-submissions-counter': {
        'task': 'kobo.apps.open_rosa_server.apps.logger.tasks.delete_daily_counters',
