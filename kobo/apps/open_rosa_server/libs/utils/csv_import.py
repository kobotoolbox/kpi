...
from kobo.apps.open_rosa_server.libs.utils.logger_tools import dict2xml, safe_create_instance
...
def get_submission_meta_dict(xform, instance_id):
    ...
    :param kobo.apps.open_rosa_server.apps.logger.models.XForm xform: The submission's XForm.
...
def dict2xmlsubmission(submission_dict, xform, instance_id, submission_date):
    ...
    :param kobo.apps.open_rosa_server.apps.logger.models.XForm xfrom: The submission's XForm.
    :param string instance_id: The submission/instance `uuid`.
...
def submit_csv(
    ...
    xform: 'kobo.apps.open_rosa_server.apps.logger.models.XForm',
    ...
    :py:func:`kobo.apps.open_rosa_server.libs.utils.logger_tools.safe_create_instance`
