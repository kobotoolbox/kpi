...
from kobo.apps.open_rosa_server.libs.utils.viewer_tools import create_attachments_zipfile
...
class ExportBuilder:
    ...
    def to_flat_csv_export(self, path, data, username, id_string, filter_query):
        # TODO resolve circular import
        from kobo.apps.open_rosa_server.apps.viewer.pandas_mongo_bridge import CSVDataFrameBuilder
