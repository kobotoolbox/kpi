...
from kobo.apps.open_rosa_server.libs.data.query import get_form_submissions_grouped_by_field,\
...
class TestTools(TestBase):
    ...
    @patch('kobo.apps.open_rosa_server.apps.logger.models.instance.submission_time')
    ...
    def test_get_form_submissions_two_xforms(self, mock_time):
        ...
        self._make_submission(os.path.join(
            'kobo.apps.open_rosa_server', 'apps', 'main', 'tests', 'fixtures', 'gps',
    ...
    def test_get_field_records_when_some_responses_are_empty(self):
        ...
        for i in submissions:
            self._make_submission(os.path.join(
                'kobo.apps.open_rosa_server', 'apps', 'api', 'tests', 'fixtures', 'forms',
