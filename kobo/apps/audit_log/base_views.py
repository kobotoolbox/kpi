...
class AuditLoggedViewSet(viewsets.GenericViewSet):
    ...
    ViewSets to implement additional logic for get_object, perform_update, and
    perform_create via the get_object_override, perform_update override, and
    perform_create methods.
    ...
    def perform_create(self, serializer):
        ...
        for field in self.logged_fields:
            value = get_nested_field(serializer.instance, field)
            audit_log_data[field] = value
        self.request._request.updated = audit_log_data
