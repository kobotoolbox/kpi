...
from kobo.apps.superuser_stats.views import _base_filename_to_full_filename
from .tasks import generate_country_report
...
def country_report(request):
    ...
    generate_country_report.delay(filename, request)
    template_ish = (
