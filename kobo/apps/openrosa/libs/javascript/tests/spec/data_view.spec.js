describe('FH.DataTableView', () => {
  describe('FH.DataTableView.NameOrLabel on select one', () => {
    ...
    it('should return the raw value when showLabels is disabled', () => {
    ...
    it('should return the select label when showLabels is enabled', () => {
  ...
  describe('FH.DataTableView.NameOrLabel on select multiple', () => {
    var field = new FH.Field({
      _id: 'browsers',
    ...
    it('should return a comma separated list of labels when showLabels is true', () => {
