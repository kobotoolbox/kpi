...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      'onadata/apps/main/static/bower_components/lunr.js/lunr.min.js',
      'onadata/apps/main/static/bower_components/backbone-pageable/lib/backbone-pageable.min.js',
      'onadata/apps/main/static/bower_components/backgrid-filter/backgrid-filter.min.js',
      'onadata/apps/main/static/bower_components/backgrid-paginator/backgrid-paginator.min.js',
