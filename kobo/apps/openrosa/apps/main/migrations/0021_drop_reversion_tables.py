...
def get_operations():
    ...
    try:
        ...
        print(
            f'[0021_drop_reversion_tables] Could not connect to kobocat '
...
class Migration(migrations.Migration):
    """
    Drops the django-reversion tables from the kobocat database.

    DROP TABLE is instantaneous in PostgreSQL regardless of row count.
    """

    dependencies = [
        ('main', '0020_alter_main_models_options'),
    ]
