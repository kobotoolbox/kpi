...
class ScimUsersAPITests(APITestCase):
    ...
    def test_create_user_unique_username_generator(self):
        ...
        resp1 = self.client.post(self.url, payload1, format='json', HTTP_ACCEPT='application/scim+json')
        ...
        resp2 = self.client.post(self.url, payload2, format='json', HTTP_ACCEPT='application/scim+json')
        ...
        resp3 = self.client.post(self.url, payload3, format='json', HTTP_ACCEPT='application/scim+json')
    ...
    def test_create_user_unique_username_different_idps(self):
        ...
        resp2 = self.client.post(url_2, payload2, format='json', HTTP_ACCEPT='application/scim+json')
        self.assertEqual(resp2.status_code, status.HTTP_201_CREATED)
