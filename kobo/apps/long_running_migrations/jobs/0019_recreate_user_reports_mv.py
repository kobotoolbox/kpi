...
def run():
    ...
    --force bypasses SKIP_HEAVY_MIGRATIONS. This is required here: without
    it, the command would reschedule the long-running migration instead of
    executing it, causing this job to loop indefinitely.
    """
