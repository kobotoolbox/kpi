...
class LazyDefaultBooleanField(models.PositiveSmallIntegerField):
    ...
    models.BooleanField can't be nullable, so we use models.IntegerField to
    mimic models.BooleanField behaviour
    """
    def __init__(self, *args, **kwargs):
        ...
        if self.lazy_default is None:
            ...
            raise FieldError(
                'LazyDefaultBooleanField requires the default value'
                'to be a boolean'
            )
