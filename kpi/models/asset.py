...
class Asset(ObjectPermissionMixin,
    ...
    class Meta:
        ...
        permissions = (
            ...
            (PERM_VIEW_METADATA, t('Can view asset metadata')),
            (PERM_CHANGE_METADATA, t('Can edit asset metadata')),
    ...
    ASSIGNABLE_PERMISSIONS_WITH_LABELS = {
        ...
        PERM_VIEW_METADATA: t('View metadata'),
        PERM_CHANGE_METADATA: t('Edit metadata'),
    ...
    IMPLIED_PERMISSIONS = {
        ...
        PERM_VIEW_METADATA: (PERM_VIEW_ASSET,),
        PERM_CHANGE_METADATA: (PERM_VIEW_ASSET, PERM_VIEW_METADATA,),
