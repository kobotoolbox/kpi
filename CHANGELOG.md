...
- **attachments**: resolve question xpath on the name the client sent ([#7609](https://github.com/kobotoolbox/kpi/pull/7609))
    > <!-- 📣 Summary -->
    > 
...
- **auth**: remove unnecessary managed sso domains sync in migration ([#7591](https://github.com/kobotoolbox/kpi/pull/7591))
    > <!-- 📣 Summary -->
...
- **exports**: include submissions in XLS (legacy) exports of transferred projects ([#7623](https://github.com/kobotoolbox/kpi/pull/7623))
    > <!-- 📣 Summary -->
...
- **massemails**: fix edge cases for one-off mass email campaigns ([#7555](https://github.com/kobotoolbox/kpi/pull/7555))
    > <!-- 📣 Summary -->
