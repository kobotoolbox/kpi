...
- **longRunningMigrations**: make 0020 batch size small to avoid OOM ([#6875](https://github.com/kobotoolbox/kpi/pull/6875))
- **map**: OpenStreetMap 403r error ([#6869](https://github.com/kobotoolbox/kpi/pull/6869))
    > <!-- 📣 Summary -->
    > 
...
- **userReport**: fix `mfa_is_active` not reflecting correct MFA status in user-reports ([#6861](https://github.com/kobotoolbox/kpi/pull/6861))
    > <!-- 📣 Summary -->
...
- **userReports**: prevent infinite loop in MV background job ([#6876](https://github.com/kobotoolbox/kpi/pull/6876))
- **userReports**: prevent infinite loop in MV background job ([#6878](https://github.com/kobotoolbox/kpi/pull/6878))
</details>
...
- **admin**: prevent manual username changes for existing users in Django admin ([#6839](https://github.com/kobotoolbox/kpi/pull/6839))
    > <!-- 📣 Summary -->
...
- **permissions**: org admins can see and manage all asset permissions ([#6836](https://github.com/kobotoolbox/kpi/pull/6836))
    > <!-- 📣 Summary -->
    > 
...
- **scripts**: display detailed error output on unexpected migration failures ([#6830](https://github.com/kobotoolbox/kpi/pull/6830))
    > <!-- 📣 Summary -->
    ...
    > [kpi#6796](https://github.com/kobotoolbox/kpi/pull/6796)), we automated
...
- **viewer**: improve user-agent parsing for Enketo and Collect ([#6780](https://github.com/kobotoolbox/kpi/pull/6780))
    > <!-- 📣 Summary -->
    > 
...
<details><summary>Bug Fixes (72)</summary>
...
- **logging**: prevent duplicate logs by disabling propagation to root logger ([#6808](https://github.com/kobotoolbox/kpi/pull/6808))
    > <!-- 📣 Summary -->
    > 
...
- **subsequences**: make translations always synchronous ([#6762](https://github.com/kobotoolbox/kpi/pull/6762))
    > <!-- 📣 Summary -->
...
<details><summary>Build & Dependencies (2)</summary>

- **api**: [**breaking**] remove django-rest-framework frontend files ([#6736](https://github.com/kobotoolbox/kpi/pull/6736))
    > <!-- 📣 Summary -->
...
- **deps**: revert formpack to commit e43428525 (refactored subsequences app) ([#6807](https://github.com/kobotoolbox/kpi/pull/6807))
    > <!-- 📣 Summary -->
    > 
