...
- **longRunningMigrations**: reprocess XForms wrongly tagged by 0027 ([#7273](https://github.com/kobotoolbox/kpi/pull/7273))
    > <!-- 📣 Summary -->
    > 
...
- **projectViews**: show organization IDs in the admin organization selector ([#7331](https://github.com/kobotoolbox/kpi/pull/7331))
    > <!-- 📣 Summary -->
    > 
...
- **analytics**: update gtag function declaration ([#7318](https://github.com/kobotoolbox/kpi/pull/7318))
- **api**: return generic messages instead of raw exception text ([#7338](https://github.com/kobotoolbox/kpi/pull/7338))
    > <!-- 📣 Summary -->
    > 
...
- **bulkProcessing**: keep activity log progress in sync with bulk items ([#7337](https://github.com/kobotoolbox/kpi/pull/7337))
    > <!-- 📣 Summary -->
...
- **longRunningMigrations**: persist LRM 0027/0028 cursor ([#7312](https://github.com/kobotoolbox/kpi/pull/7312))
    > <!-- 📣 Summary -->
    > 
...
- **longRunningMigrations**: avoid full index scan in LRM 0027 xform paging ([#7333](https://github.com/kobotoolbox/kpi/pull/7333))
    > <!-- 📣 Summary -->
    > 
...
<details><summary>Continous Integration (10)</summary>

- **releases**: improve checkout-with-github-app-token action ([#7364](https://github.com/kobotoolbox/kpi/pull/7364))
- **releases**: extract changelog generation into reusable workflow ([#7365](https://github.com/kobotoolbox/kpi/pull/7365))
- **releases**: cleanup branch workflow ([#7368](https://github.com/kobotoolbox/kpi/pull/7368))
- **releases**: refactor many tests to a single gate job ([#7369](https://github.com/kobotoolbox/kpi/pull/7369))
- **releases**: advanced merge forward ([#7370](https://github.com/kobotoolbox/kpi/pull/7370))
- **releases**: fix gate skip propogation ([#7383](https://github.com/kobotoolbox/kpi/pull/7383))
- **releases**: build a release ([#7372](https://github.com/kobotoolbox/kpi/pull/7372))
- **releases**: publish github release notes ([#7373](https://github.com/kobotoolbox/kpi/pull/7373))
- **releases**: integrate Linear Releases ([#7374](https://github.com/kobotoolbox/kpi/pull/7374))
- **releases**: add skip/delete release workflow ([#7367](https://github.com/kobotoolbox/kpi/pull/7367))
</details>
...
- **frontend**: commit msw build ([#7319](https://github.com/kobotoolbox/kpi/pull/7319))
...
- pull transifex translations for 2.026.30 ([fbc8572](https://github.com/kobotoolbox/kpi/commit/fbc8572093406bcf886d45588263f3ddec7d040f))
</details>
