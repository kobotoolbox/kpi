...
<details><summary>Features (29)</summary>
...
- **massEmails**: simplify inactive/active user queries ([#7170](https://github.com/kobotoolbox/kpi/pull/7170))
    > <!-- 📣 Summary -->
    > 
    > Internal only — no user-visible change.
    > 
...
**Full Changelog**: https://github.com/kobotoolbox/kpi/compare/2.026.23..2.026.26
