TODO: Update the release and the guide URL

# Endpoint removals as of release 2.025.__

⚠️ The endpoints listed below were removed with the first release of June 2026.

Use (this guide)[__] to migrate from KoboCAT `v1` to KPI `v2` API
