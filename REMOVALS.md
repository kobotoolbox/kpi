...
to transition from v1 to the KPI v2 API.
...
<sup>†</sup> _No equivalent endpoint available._
<sup>‡</sup> _Use the OpenRosa submission endpoints: `/submission`, `/{username}/submission`,
or `/collector/{token}/submission`._
...
# Endpoint removals as of release 2.025.10

## Partial `/api/v1/data` removals
